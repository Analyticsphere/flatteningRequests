...
tiers_to_update    <- c('prod') # GCP tiers to update sch. queries for
...
for (tier in tiers_to_update){
  print(tier)
    query <- 
      generate_flattening_query(source_table      = query_config$data_source[tier],
                                destination_table = query_config$output_table,
