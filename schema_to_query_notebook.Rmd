...
table   <- switch(table_selection,
                  "Connect.biospecimen",  # 1
                  "Connect.bioSurvey_v1", # 2
                  "Connect.clinicalBioSurvey_v1", # 3
                  "Connect.menstrualSurvey_v1",   # 4
                  "Connect.module1_v1",  # 5
                  "Connect.module1_v2",  # 6
                  "Connect.module2_v1",  # 7
                  "Connect.module1_v2",  # 8
                  "Connect.module3_v1",  # 9
                  "Connect.module4_v1",  # 10
                  "Connect.participants" # 11
                  )
table
#########################################################
...
for (project_id in project_id_list){
  ...
  if (resource_name != get_resource_name_of_bq_sch_query(project_id, table_name)) {
