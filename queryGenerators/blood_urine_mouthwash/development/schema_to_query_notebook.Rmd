...
library(tools)
source(
  paste0("/Users/petersjm/Documents/dataFlattening/flatteningRequests/",
         "queryGenerators/M1/filterVarsFromSchema/",
         "connect_analytics_helper_functions.R")
        )
...
schema   <- paste0("/Users/petersjm/Documents/dataFlattening/",
                   "flatteningRequests/queryGenerators/blood_urine_mouthwash/",
                   "development/blood_urine_mouthwash_schema.xlsx")
sheet    <- "stg"
out_json <- "BUM-lists-stg.js" # destination file
out_csv  <- "BUM-variables-stg.csv"

filter_vars_from_schema(project, table, schema, out_csv, out_json, sheet=sheet)
