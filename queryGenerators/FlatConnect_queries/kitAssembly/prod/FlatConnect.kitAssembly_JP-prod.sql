...
-- 
-- source_table: nih-nci-dceg-connect-prod-6d04.Connect.kitAssembly
-- destination table: nih-nci-dceg-connect-prod-6d04.FlatConnect.kitAssembly_JP -- notes
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-prod-6d04.FlatConnect.kitAssembly_JP` -- destination_table
  ...
  WITH
    ...
    FROM
      `nih-nci-dceg-connect-prod-6d04.Connect.kitAssembly` AS input_row -- source_table
