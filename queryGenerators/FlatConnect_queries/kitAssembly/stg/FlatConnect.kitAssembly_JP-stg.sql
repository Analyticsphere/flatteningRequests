...
-- destination table: nih-nci-dceg-connect-stg-5519.FlatConnect.kitAssembly_JP -- notes
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-stg-5519.FlatConnect.kitAssembly_JP` -- destination_table
