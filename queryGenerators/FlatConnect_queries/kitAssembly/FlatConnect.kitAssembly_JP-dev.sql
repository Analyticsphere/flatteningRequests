...
CREATE OR REPLACE TABLE
  ...
  WITH
	...
	REPLACE(JSON_QUERY(row,'$.d_633640710.entity.d_100618603'), '\"', '') AS d_633640710_entity_d_100618603,
	REPLACE(JSON_QUERY(row,'$.d_633640710.entity.d_205954477'), '\"', '') AS d_633640710_entity_d_205954477,
	REPLACE(JSON_QUERY(row,'$.d_633640710.entity.d_289239334'), '\"', '') AS d_633640710_entity_d_289239334,
	REPLACE(JSON_QUERY(row,'$.d_633640710.entity.d_427719697'), '\"', '') AS d_633640710_entity_d_427719697,
	REPLACE(JSON_QUERY(row,'$.d_633640710.entity.d_541085383'), '\"', '') AS d_633640710_entity_d_541085383,
	REPLACE(JSON_QUERY(row,'$.d_633640710.entity.d_545319575'), '\"', '') AS d_633640710_entity_d_545319575,
	REPLACE(JSON_QUERY(row,'$.d_633640710.entity.d_938338155'), '\"', '') AS d_633640710_entity_d_938338155,
	REPLACE(JSON_QUERY(row,'$.d_633640710.entity.d_950521660'), '\"', '') AS d_633640710_entity_d_950521660,
	REPLACE(JSON_QUERY(row,'$.d_633640710.entity.d_992420392'), '\"', '') AS d_633640710_entity_d_992420392,
	REPLACE(JSON_QUERY(row,'$.d_633640710.provided'), '\"', '') AS d_633640710_provided,
	REPLACE(JSON_QUERY(row,'$.d_633640710.string'), '\"', '') AS d_633640710_string,
