...
# project  <- "nih-nci-dceg-connect-stg-5519"1
project  <- "nih-nci-dceg-connect-prod-6d04"
table    <- "Connect.module3_v1"
schema   <- "module3_v1-schema.xlsx"
sheet    <- NULL
out_json <- "module3_v1-lists-from-schema.json" # destination file
out_csv  <- "module3_v1-variables-from-schema.csv"
...
```{r}
#TODO remove __error__ variable before this step!
A <- "../module3_v1-lists.json"
B <- "module3_v1-lists-from-schema.json"
C <- "module3_v1-lists-union.json"
...
A_csv <- "../module4_v1-variables.csv"
B_csv <- "module4_v1-variables-from-schema.csv"
C_csv <- "module4_v1-variables-union.csv"
...
```{r}
json_file         <- out_json #C
variables_file    <- out_csv #C_csv
...
echo $NEW_CSV  
echo $NEW_JSON
PAR_DIR_CSV_NAME="module3_v1-variables.csv"
PAR_DIR_JSON_NAME="module3_v1-lists.json"
...
node ../module4_v1-query_generator.js
```
