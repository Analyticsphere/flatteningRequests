...
table    <- "Connect.bioSurvey_v1"
schema   <- "bioSurvey_v1-schema.xlsx"
sheet    <- NULL
out_json <- "bioSurvey_v1-lists-from-schema.json" # destination file
out_csv  <- "bioSurvey_v1-variables-from-schema.csv"
...
```{r}
A <- "../bioSurvey_v1-lists.json"
B <- "bioSurvey-lists-from-schema.json"
C <- "bioSurvey-lists-union.json"
...
A_csv <- "../bioSurvey_v1-variables.csv"
B_csv <- "bioSurvey_v1-variables-from-schema.csv"
C_csv <- "bioSurvey_v1-variables-union.csv"
...
```{r}
output_filename  <- "bioSurvey_v1-lists-union-mod.json"
...
```{r}
out_file  <- "bioSurvey_v1-variables-union-new.csv"
...
echo $NEW_CSV  
echo $NEW_JSON
PAR_DIR_CSV_NAME="bioSurvey_v1-variables.csv"
PAR_DIR_JSON_NAME="bioSurvey_v1-lists.json"
...
node ../bioSurvey_v1-query_generator.js
```
