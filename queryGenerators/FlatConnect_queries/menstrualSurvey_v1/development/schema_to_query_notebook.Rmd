...
schema   <- "menstrualSurvey_v1-schema.xlsx"
sheet    <- NULL
out_json <- "menstrualSurvey_v1-lists-from-schema.json" # destination file
out_csv  <- "menstrualSurvey_v1-variables-from-schema.csv"
