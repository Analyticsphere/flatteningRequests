...
""";
  ...
  json_data AS (
    ...
    FROM
      `nih-nci-dceg-connect-dev.Connect.module3_v1` AS input_row where Connect_ID is not null
  ),
  flattened_data AS (
    SELECT
...
REPLACE(JSON_QUERY(row,'$.D_103566006.D_103566006.D_325879966'), '\"', '') AS D_103566006_D_103566006_D_325879966,
...
REPLACE(JSON_QUERY(row,'$.D_104676242'), '\"', '') AS D_104676242,
REPLACE(JSON_QUERY(row,'$.D_106272739'), '\"', '') AS D_106272739,
REPLACE(JSON_QUERY(row,'$.D_115909186'), '\"', '') AS D_115909186,
REPLACE(JSON_QUERY(row,'$.D_116014097'), '\"', '') AS D_116014097,
REPLACE(JSON_QUERY(row,'$.D_116080663.D_116080663'), '\"', '') AS D_116080663_D_116080663,
...
REPLACE(JSON_QUERY(row,'$.D_123926260'), '\"', '') AS D_123926260,
REPLACE(JSON_QUERY(row,'$.D_127038003'), '\"', '') AS D_127038003,
...
REPLACE(JSON_QUERY(row,'$.D_137733407'), '\"', '') AS D_137733407,
REPLACE(JSON_QUERY(row,'$.D_140848765'), '\"', '') AS D_140848765,
REPLACE(JSON_QUERY(row,'$.D_141874857'), '\"', '') AS D_141874857,
...
REPLACE(JSON_QUERY(row,'$.D_154603497.D_154603497'), '\"', '') AS D_154603497_D_154603497,
REPLACE(JSON_QUERY(row,'$.D_154603497.D_234430294'), '\"', '') AS D_154603497_D_234430294,
REPLACE(JSON_QUERY(row,'$.D_158841370'), '\"', '') AS D_158841370,
REPLACE(JSON_QUERY(row,'$.D_164707243'), '\"', '') AS D_164707243,
REPLACE(JSON_QUERY(row,'$.D_171050898'), '\"', '') AS D_171050898,
REPLACE(JSON_QUERY(row,'$.D_175385712'), '\"', '') AS D_175385712,
...
REPLACE(JSON_QUERY(row,'$.D_214983579'), '\"', '') AS D_214983579,
REPLACE(JSON_QUERY(row,'$.D_227439141'), '\"', '') AS D_227439141,
REPLACE(JSON_QUERY(row,'$.D_227784207'), '\"', '') AS D_227784207,
REPLACE(JSON_QUERY(row,'$.D_228752045'), '\"', '') AS D_228752045,
REPLACE(JSON_QUERY(row,'$.D_234430294'), '\"', '') AS D_234430294,
...
REPLACE(JSON_QUERY(row,'$.D_240089798'), '\"', '') AS D_240089798,
...
REPLACE(JSON_QUERY(row,'$.D_257300783.D_257300783'), '\"', '') AS D_257300783_D_257300783,
REPLACE(JSON_QUERY(row,'$.D_257300783.D_424527685'), '\"', '') AS D_257300783_D_424527685,
REPLACE(JSON_QUERY(row,'$.D_257564920'), '\"', '') AS D_257564920,
...
REPLACE(JSON_QUERY(row,'$.D_265469878.D_997708616'), '\"', '') AS D_265469878_D_997708616,
...
REPLACE(JSON_QUERY(row,'$.D_294629316'), '\"', '') AS D_294629316,
...
REPLACE(JSON_QUERY(row,'$.D_319252189'), '\"', '') AS D_319252189,
REPLACE(JSON_QUERY(row,'$.D_319397722'), '\"', '') AS D_319397722,
REPLACE(JSON_QUERY(row,'$.D_319871370'), '\"', '') AS D_319871370,
REPLACE(JSON_QUERY(row,'$.D_325229459'), '\"', '') AS D_325229459,
REPLACE(JSON_QUERY(row,'$.D_325879966'), '\"', '') AS D_325879966,
...
REPLACE(JSON_QUERY(row,'$.D_338914506'), '\"', '') AS D_338914506,
...
REPLACE(JSON_QUERY(row,'$.D_349034127'), '\"', '') AS D_349034127,
REPLACE(JSON_QUERY(row,'$.D_349510816'), '\"', '') AS D_349510816,
...
REPLACE(JSON_QUERY(row,'$.D_359443374'), '\"', '') AS D_359443374,
...
REPLACE(JSON_QUERY(row,'$.D_378254382.D_378254382'), '\"', '') AS D_378254382_D_378254382,
...
REPLACE(JSON_QUERY(row,'$.D_392301875'), '\"', '') AS D_392301875,
...
REPLACE(JSON_QUERY(row,'$.D_408696162'), '\"', '') AS D_408696162,
...
REPLACE(JSON_QUERY(row,'$.D_424527685'), '\"', '') AS D_424527685,
REPLACE(JSON_QUERY(row,'$.D_429228540'), '\"', '') AS D_429228540,
REPLACE(JSON_QUERY(row,'$.D_432310123'), '\"', '') AS D_432310123,
REPLACE(JSON_QUERY(row,'$.D_434034366'), '\"', '') AS D_434034366,
REPLACE(JSON_QUERY(row,'$.D_440364083'), '\"', '') AS D_440364083,
...
REPLACE(JSON_QUERY(row,'$.D_446121108'), '\"', '') AS D_446121108,
...
REPLACE(JSON_QUERY(row,'$.D_459020144'), '\"', '') AS D_459020144,
...
REPLACE(JSON_QUERY(row,'$.D_470096941'), '\"', '') AS D_470096941,
...
REPLACE(JSON_QUERY(row,'$.D_470862706.D_715827646.D_137733407'), '\"', '') AS D_470862706_D_715827646_D_137733407,
REPLACE(JSON_QUERY(row,'$.D_470862706.D_715827646.D_663253668'), '\"', '') AS D_470862706_D_715827646_D_663253668,
REPLACE(JSON_QUERY(row,'$.D_470862706.D_715827646.D_789689151'), '\"', '') AS D_470862706_D_715827646_D_789689151,
...
REPLACE(JSON_QUERY(row,'$.D_477756737'), '\"', '') AS D_477756737,
REPLACE(JSON_QUERY(row,'$.D_479400169'), '\"', '') AS D_479400169,
...
REPLACE(JSON_QUERY(row,'$.D_486287398'), '\"', '') AS D_486287398,
...
REPLACE(JSON_QUERY(row,'$.D_509170471'), '\"', '') AS D_509170471,
...
REPLACE(JSON_QUERY(row,'$.D_517801904'), '\"', '') AS D_517801904,
...
REPLACE(JSON_QUERY(row,'$.D_531654334'), '\"', '') AS D_531654334,
REPLACE(JSON_QUERY(row,'$.D_532755074'), '\"', '') AS D_532755074,
REPLACE(JSON_QUERY(row,'$.D_534351312'), '\"', '') AS D_534351312,
REPLACE(JSON_QUERY(row,'$.D_535003378'), '\"', '') AS D_535003378,
REPLACE(JSON_QUERY(row,'$.D_536166591'), '\"', '') AS D_536166591,
REPLACE(JSON_QUERY(row,'$.D_536216847'), '\"', '') AS D_536216847,
REPLACE(JSON_QUERY(row,'$.D_537807075'), '\"', '') AS D_537807075,
REPLACE(JSON_QUERY(row,'$.D_539648641'), '\"', '') AS D_539648641,
REPLACE(JSON_QUERY(row,'$.D_544356746'), '\"', '') AS D_544356746,
REPLACE(JSON_QUERY(row,'$.D_546410473.D_546410473'), '\"', '') AS D_546410473_D_546410473,
REPLACE(JSON_QUERY(row,'$.D_546410473.D_663551714'), '\"', '') AS D_546410473_D_663551714,
REPLACE(JSON_QUERY(row,'$.D_549079588'), '\"', '') AS D_549079588,
...
REPLACE(JSON_QUERY(row,'$.D_550244580.D_550244580'), '\"', '') AS D_550244580_D_550244580,
REPLACE(JSON_QUERY(row,'$.D_550850568'), '\"', '') AS D_550850568,
REPLACE(JSON_QUERY(row,'$.D_551301510'), '\"', '') AS D_551301510,
REPLACE(JSON_QUERY(row,'$.D_556837046.D_141874857'), '\"', '') AS D_556837046_D_141874857,
REPLACE(JSON_QUERY(row,'$.D_556837046.D_556837046'), '\"', '') AS D_556837046_D_556837046,
...
REPLACE(JSON_QUERY(row,'$.D_572260608'), '\"', '') AS D_572260608,
REPLACE(JSON_QUERY(row,'$.D_575237218'), '\"', '') AS D_575237218,
REPLACE(JSON_QUERY(row,'$.D_576358766'), '\"', '') AS D_576358766,
...
REPLACE(JSON_QUERY(row,'$.D_586306068'), '\"', '') AS D_586306068,
...
REPLACE(JSON_QUERY(row,'$.D_602102163'), '\"', '') AS D_602102163,
...
REPLACE(JSON_QUERY(row,'$.D_622394149'), '\"', '') AS D_622394149,
REPLACE(JSON_QUERY(row,'$.D_622843252'), '\"', '') AS D_622843252,
REPLACE(JSON_QUERY(row,'$.D_624111331'), '\"', '') AS D_624111331,
REPLACE(JSON_QUERY(row,'$.D_628770824'), '\"', '') AS D_628770824,
REPLACE(JSON_QUERY(row,'$.D_628818510'), '\"', '') AS D_628818510,
...
REPLACE(JSON_QUERY(row,'$.D_653198444.D_653198444'), '\"', '') AS D_653198444_D_653198444,
...
REPLACE(JSON_QUERY(row,'$.D_663253668'), '\"', '') AS D_663253668,
REPLACE(JSON_QUERY(row,'$.D_663551714'), '\"', '') AS D_663551714,
REPLACE(JSON_QUERY(row,'$.D_666840938'), '\"', '') AS D_666840938,
REPLACE(JSON_QUERY(row,'$.D_667002790'), '\"', '') AS D_667002790,
REPLACE(JSON_QUERY(row,'$.D_670036093'), '\"', '') AS D_670036093,
...
REPLACE(JSON_QUERY(row,'$.D_675129470'), '\"', '') AS D_675129470,
REPLACE(JSON_QUERY(row,'$.D_677733128'), '\"', '') AS D_677733128,
REPLACE(JSON_QUERY(row,'$.D_679300202'), '\"', '') AS D_679300202,
REPLACE(JSON_QUERY(row,'$.D_680697711'), '\"', '') AS D_680697711,
REPLACE(JSON_QUERY(row,'$.D_681586194'), '\"', '') AS D_681586194,
REPLACE(JSON_QUERY(row,'$.D_685659661'), '\"', '') AS D_685659661,
REPLACE(JSON_QUERY(row,'$.D_686310465'), '\"', '') AS D_686310465,
REPLACE(JSON_QUERY(row,'$.D_689339933'), '\"', '') AS D_689339933,
...
REPLACE(JSON_QUERY(row,'$.D_706254326'), '\"', '') AS D_706254326,
REPLACE(JSON_QUERY(row,'$.D_711858159'), '\"', '') AS D_711858159,
REPLACE(JSON_QUERY(row,'$.D_712653855'), '\"', '') AS D_712653855,
REPLACE(JSON_QUERY(row,'$.D_713594719'), '\"', '') AS D_713594719,
...
REPLACE(JSON_QUERY(row,'$.D_732465277'), '\"', '') AS D_732465277,
...
REPLACE(JSON_QUERY(row,'$.D_738219521.D_75237218'), '\"', '') AS D_738219521_D_75237218,
...
REPLACE(JSON_QUERY(row,'$.D_741643840'), '\"', '') AS D_741643840,
REPLACE(JSON_QUERY(row,'$.D_742254559.D_185168695'), '\"', '') AS D_742254559_D_185168695,
REPLACE(JSON_QUERY(row,'$.D_742254559.D_742254559'), '\"', '') AS D_742254559_D_742254559,
REPLACE(JSON_QUERY(row,'$.D_742544044'), '\"', '') AS D_742544044,
REPLACE(JSON_QUERY(row,'$.D_742716427'), '\"', '') AS D_742716427,
...
REPLACE(JSON_QUERY(row,'$.D_760521319'), '\"', '') AS D_760521319,
...
REPLACE(JSON_QUERY(row,'$.D_767711152'), '\"', '') AS D_767711152,
REPLACE(JSON_QUERY(row,'$.D_770257102'), '\"', '') AS D_770257102,
REPLACE(JSON_QUERY(row,'$.D_771426895'), '\"', '') AS D_771426895,
REPLACE(JSON_QUERY(row,'$.D_772143730'), '\"', '') AS D_772143730,
REPLACE(JSON_QUERY(row,'$.D_777877159'), '\"', '') AS D_777877159,
REPLACE(JSON_QUERY(row,'$.D_779642303'), '\"', '') AS D_779642303,
...
REPLACE(JSON_QUERY(row,'$.D_781650542'), '\"', '') AS D_781650542,
...
REPLACE(JSON_QUERY(row,'$.D_789689151'), '\"', '') AS D_789689151,
REPLACE(JSON_QUERY(row,'$.D_790436165.D_408696162'), '\"', '') AS D_790436165_D_408696162,
REPLACE(JSON_QUERY(row,'$.D_790436165.D_790436165'), '\"', '') AS D_790436165_D_790436165,
REPLACE(JSON_QUERY(row,'$.D_790681252'), '\"', '') AS D_790681252,
...
REPLACE(JSON_QUERY(row,'$.D_807835037'), '\"', '') AS D_807835037,
REPLACE(JSON_QUERY(row,'$.D_810324917.D_479400169'), '\"', '') AS D_810324917_D_479400169,
REPLACE(JSON_QUERY(row,'$.D_810324917.D_807835037'), '\"', '') AS D_810324917_D_807835037,
REPLACE(JSON_QUERY(row,'$.D_810324917.D_810324917'), '\"', '') AS D_810324917_D_810324917,
REPLACE(JSON_QUERY(row,'$.D_810608313'), '\"', '') AS D_810608313,
REPLACE(JSON_QUERY(row,'$.D_812430894'), '\"', '') AS D_812430894,
REPLACE(JSON_QUERY(row,'$.D_814115676.D_814115676'), '\"', '') AS D_814115676_D_814115676,
...
REPLACE(JSON_QUERY(row,'$.D_817381897'), '\"', '') AS D_817381897,
REPLACE(JSON_QUERY(row,'$.D_818310825'), '\"', '') AS D_818310825,
...
REPLACE(JSON_QUERY(row,'$.D_822964046'), '\"', '') AS D_822964046,
...
REPLACE(JSON_QUERY(row,'$.D_843593800'), '\"', '') AS D_843593800,
REPLACE(JSON_QUERY(row,'$.D_845122623'), '\"', '') AS D_845122623,
REPLACE(JSON_QUERY(row,'$.D_847277590'), '\"', '') AS D_847277590,
REPLACE(JSON_QUERY(row,'$.D_851145096'), '\"', '') AS D_851145096,
...
REPLACE(JSON_QUERY(row,'$.D_866159532'), '\"', '') AS D_866159532,
...
REPLACE(JSON_QUERY(row,'$.D_882838859'), '\"', '') AS D_882838859,
REPLACE(JSON_QUERY(row,'$.D_888898065'), '\"', '') AS D_888898065,
REPLACE(JSON_QUERY(row,'$.D_889023234'), '\"', '') AS D_889023234,
REPLACE(JSON_QUERY(row,'$.D_889949861'), '\"', '') AS D_889949861,
REPLACE(JSON_QUERY(row,'$.D_891825638'), '\"', '') AS D_891825638,
REPLACE(JSON_QUERY(row,'$.D_891996278'), '\"', '') AS D_891996278,
REPLACE(JSON_QUERY(row,'$.D_895826652'), '\"', '') AS D_895826652,
REPLACE(JSON_QUERY(row,'$.D_896953195'), '\"', '') AS D_896953195,
REPLACE(JSON_QUERY(row,'$.D_906155105'), '\"', '') AS D_906155105,
...
REPLACE(JSON_QUERY(row,'$.D_941830839'), '\"', '') AS D_941830839,
REPLACE(JSON_QUERY(row,'$.D_942945860.D_742716427'), '\"', '') AS D_942945860_D_742716427,
REPLACE(JSON_QUERY(row,'$.D_942945860.D_942945860'), '\"', '') AS D_942945860_D_942945860,
...
REPLACE(JSON_QUERY(row,'$.D_959535900'), '\"', '') AS D_959535900,
...
REPLACE(JSON_QUERY(row,'$.D_976863738'), '\"', '') AS D_976863738,
