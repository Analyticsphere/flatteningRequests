...
const dataSource = {
  dev: 'nih-nci-dceg-connect-dev.Connect.module3_v1',
  stg: 'nih-nci-dceg-connect-stg-5519.Connect.module3_v1',
  prod: 'nih-nci-dceg-connect-prod-6d04.Connect.module3_v1',
};
const pathToConceptIdList = require('./module3_v1-lists');
let variables = fs
  .readFileSync('./module3_v1-variables.csv', 'utf8')
  .split(/\r?\n/)
...
""";
  ...
  fs.writeFileSync(`./FlatConnect.module3_v1_JP-${tier}.sql`, content);
}
