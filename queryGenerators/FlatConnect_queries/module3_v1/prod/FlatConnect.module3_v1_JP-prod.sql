...
-- destination table: FlatConnect.module3_v1_JP -- notes
...
CREATE OR REPLACE TABLE
  FlatConnect.module3_v1_JP -- destination_table
  ...
  WITH
	...
	REPLACE(JSON_QUERY(row,'$.D_252017075.D_106272739_sm'), '\"', '') AS D_252017075_D_106272739_sm,
	REPLACE(JSON_QUERY(row,'$.D_252017075.D_257564920'), '\"', '') AS D_252017075_D_257564920,
	REPLACE(JSON_QUERY(row,'$.D_252017075.D_257564920_sm'), '\"', '') AS D_252017075_D_257564920_sm,
	REPLACE(JSON_QUERY(row,'$.D_252017075.D_359443374'), '\"', '') AS D_252017075_D_359443374,
	REPLACE(JSON_QUERY(row,'$.D_252017075.D_359443374_sm'), '\"', '') AS D_252017075_D_359443374_sm,
	REPLACE(JSON_QUERY(row,'$.D_252017075.D_670036093'), '\"', '') AS D_252017075_D_670036093,
	REPLACE(JSON_QUERY(row,'$.D_252017075.D_670036093_sm'), '\"', '') AS D_252017075_D_670036093_sm,
	...
	REPLACE(JSON_QUERY(row,'$.D_633553324.D_164707243_sm'), '\"', '') AS D_633553324_D_164707243_sm,
	REPLACE(JSON_QUERY(row,'$.D_633553324.D_175385712'), '\"', '') AS D_633553324_D_175385712,
	REPLACE(JSON_QUERY(row,'$.D_633553324.D_175385712_sm'), '\"', '') AS D_633553324_D_175385712_sm,
	...
	REPLACE(JSON_QUERY(row,'$.D_633553324.D_771426895_sm'), '\"', '') AS D_633553324_D_771426895_sm,
	REPLACE(JSON_QUERY(row,'$.D_633553324.D_772143730'), '\"', '') AS D_633553324_D_772143730,
	REPLACE(JSON_QUERY(row,'$.D_633553324.D_772143730_sm'), '\"', '') AS D_633553324_D_772143730_sm,
	REPLACE(JSON_QUERY(row,'$.D_633553324.D_818310825'), '\"', '') AS D_633553324_D_818310825,
	REPLACE(JSON_QUERY(row,'$.D_633553324.D_818310825_sm'), '\"', '') AS D_633553324_D_818310825_sm,
	REPLACE(JSON_QUERY(row,'$.D_633553324.D_843593800'), '\"', '') AS D_633553324_D_843593800,
	REPLACE(JSON_QUERY(row,'$.D_633553324.D_843593800_sm'), '\"', '') AS D_633553324_D_843593800_sm,
	...
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_392301875_sm'), '\"', '') AS D_738219521_D_392301875_sm,
	...
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_575237218_sm'), '\"', '') AS D_738219521_D_575237218_sm,
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_576358766'), '\"', '') AS D_738219521_D_576358766,
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_576358766_sm'), '\"', '') AS D_738219521_D_576358766_sm,
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_666840938'), '\"', '') AS D_738219521_D_666840938,
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_666840938_sm'), '\"', '') AS D_738219521_D_666840938_sm,
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_767711152'), '\"', '') AS D_738219521_D_767711152,
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_767711152_sm'), '\"', '') AS D_738219521_D_767711152_sm,
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_888898065'), '\"', '') AS D_738219521_D_888898065,
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_888898065_sm'), '\"', '') AS D_738219521_D_888898065_sm,
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_976863738'), '\"', '') AS D_738219521_D_976863738,
	REPLACE(JSON_QUERY(row,'$.D_738219521.D_976863738_sm'), '\"', '') AS D_738219521_D_976863738_sm,
