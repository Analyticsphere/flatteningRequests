...
schema   <- "module4_v1-schema.xlsx"
sheet    <- NULL
out_json <- "module4_v1-lists-from-schema.json" # destination file
out_csv  <- "module4_v1-variables-from-schema.csv"
...
A <- "../module4_v1-lists.json"
B <- "module4_v1-lists-from-schema.json"
C <- "module4_v1-lists-union.json"
...
```{r}
output_filename  <- "module4_v1-lists-union-mod.json"
...
```{r}
out_file  <- "module4_v1-variables-union-new.csv"
...
echo $NEW_CSV  
echo $NEW_JSON
PAR_DIR_CSV_NAME="module4_v1-variables.csv"
PAR_DIR_JSON_NAME="module4_v1-lists.json"
