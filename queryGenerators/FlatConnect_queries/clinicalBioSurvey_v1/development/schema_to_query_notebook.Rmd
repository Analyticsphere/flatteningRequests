...
sheet    <- NULL
out_json <- "clinicalBioSurvey_v1-lists-from-schema.json" # destination file
...
```{r}
A <- "clinicalBioSurvey_v1-lists.json"#"../clinicalBioSurvey_v1-lists.json"
B <- "clinicalBioSurvey_v1-lists-from-schema.json"
...
node ../clinicalBioSurvey_v1QueryGenerator.js
```
