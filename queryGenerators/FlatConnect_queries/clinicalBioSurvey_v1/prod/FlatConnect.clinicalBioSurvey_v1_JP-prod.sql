...
-- 
-- source_table: nih-nci-dceg-connect-prod-6d04.Connect.clinicalBioSurvey_v1
...
CREATE OR REPLACE TABLE
  ...
  WITH
    ...
    FROM
      `nih-nci-dceg-connect-prod-6d04.Connect.clinicalBioSurvey_v1` AS input_row -- source_table
	...
	REPLACE(JSON_QUERY(row,'$.D_487532606.D_520755310_sm'), '\"', '') AS D_487532606_D_520755310_sm,
	REPLACE(JSON_QUERY(row,'$.D_487532606.D_619765650'), '\"', '') AS D_487532606_D_619765650,
	REPLACE(JSON_QUERY(row,'$.D_487532606.D_619765650_sm'), '\"', '') AS D_487532606_D_619765650_sm,
	REPLACE(JSON_QUERY(row,'$.D_487532606.D_839329467'), '\"', '') AS D_487532606_D_839329467,
	REPLACE(JSON_QUERY(row,'$.D_487532606.D_839329467_sm'), '\"', '') AS D_487532606_D_839329467_sm,
