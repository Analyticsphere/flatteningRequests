...
-- destination table: FlatConnect.covid19Survey_v1_JP -- notes
...
CREATE OR REPLACE TABLE
  FlatConnect.covid19Survey_v1_JP -- destination_table
  ...
  WITH
	...
	REPLACE(JSON_QUERY(row,'$.D_136730307.D_126794793_sm'), '\"', '') AS D_136730307_D_126794793_sm,
	REPLACE(JSON_QUERY(row,'$.D_136730307.D_218793117'), '\"', '') AS D_136730307_D_218793117,
	REPLACE(JSON_QUERY(row,'$.D_136730307.D_218793117_sm'), '\"', '') AS D_136730307_D_218793117_sm,
	REPLACE(JSON_QUERY(row,'$.D_136730307.D_338613869'), '\"', '') AS D_136730307_D_338613869,
	REPLACE(JSON_QUERY(row,'$.D_136730307.D_338613869_sm'), '\"', '') AS D_136730307_D_338613869_sm,
	REPLACE(JSON_QUERY(row,'$.D_136730307.D_962475128'), '\"', '') AS D_136730307_D_962475128,
	REPLACE(JSON_QUERY(row,'$.D_136730307.D_962475128_sm'), '\"', '') AS D_136730307_D_962475128_sm,
	REPLACE(JSON_QUERY(row,'$.D_136730307.D_989576239'), '\"', '') AS D_136730307_D_989576239,
	REPLACE(JSON_QUERY(row,'$.D_136730307.D_989576239_sm'), '\"', '') AS D_136730307_D_989576239_sm,
	...
	REPLACE(JSON_QUERY(row,'$.D_751358419.D_238135048_sm'), '\"', '') AS D_751358419_D_238135048_sm,
	REPLACE(JSON_QUERY(row,'$.D_751358419.D_524096053'), '\"', '') AS D_751358419_D_524096053,
	REPLACE(JSON_QUERY(row,'$.D_751358419.D_524096053_sm'), '\"', '') AS D_751358419_D_524096053_sm,
	REPLACE(JSON_QUERY(row,'$.D_751358419.D_632714520'), '\"', '') AS D_751358419_D_632714520,
	REPLACE(JSON_QUERY(row,'$.D_751358419.D_632714520_sm'), '\"', '') AS D_751358419_D_632714520_sm,
	REPLACE(JSON_QUERY(row,'$.D_751358419.D_635026188'), '\"', '') AS D_751358419_D_635026188,
	REPLACE(JSON_QUERY(row,'$.D_751358419.D_635026188_sm'), '\"', '') AS D_751358419_D_635026188_sm,
	REPLACE(JSON_QUERY(row,'$.D_751358419.D_814101706'), '\"', '') AS D_751358419_D_814101706,
	REPLACE(JSON_QUERY(row,'$.D_751358419.D_814101706_sm'), '\"', '') AS D_751358419_D_814101706_sm,
	...
	REPLACE(JSON_QUERY(row,'$.D_813989715.D_151327643_sm'), '\"', '') AS D_813989715_D_151327643_sm,
	REPLACE(JSON_QUERY(row,'$.D_813989715.D_283112988'), '\"', '') AS D_813989715_D_283112988,
	REPLACE(JSON_QUERY(row,'$.D_813989715.D_283112988_sm'), '\"', '') AS D_813989715_D_283112988_sm,
	REPLACE(JSON_QUERY(row,'$.D_813989715.D_440872808'), '\"', '') AS D_813989715_D_440872808,
	REPLACE(JSON_QUERY(row,'$.D_813989715.D_440872808_sm'), '\"', '') AS D_813989715_D_440872808_sm,
	REPLACE(JSON_QUERY(row,'$.D_813989715.D_580629349'), '\"', '') AS D_813989715_D_580629349,
	REPLACE(JSON_QUERY(row,'$.D_813989715.D_580629349_sm'), '\"', '') AS D_813989715_D_580629349_sm,
	REPLACE(JSON_QUERY(row,'$.D_813989715.D_874168085'), '\"', '') AS D_813989715_D_874168085,
	REPLACE(JSON_QUERY(row,'$.D_813989715.D_874168085_sm'), '\"', '') AS D_813989715_D_874168085_sm,
	REPLACE(JSON_QUERY(row,'$.D_813989715.D_874223830'), '\"', '') AS D_813989715_D_874223830,
	REPLACE(JSON_QUERY(row,'$.D_813989715.D_874223830_sm'), '\"', '') AS D_813989715_D_874223830_sm,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_167695804'), '\"', '') AS D_847578001_D_167695804,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_167695804_sm'), '\"', '') AS D_847578001_D_167695804_sm,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_215996690'), '\"', '') AS D_847578001_D_215996690,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_215996690_sm'), '\"', '') AS D_847578001_D_215996690_sm,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_462737492'), '\"', '') AS D_847578001_D_462737492,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_462737492_sm'), '\"', '') AS D_847578001_D_462737492_sm,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_469675296'), '\"', '') AS D_847578001_D_469675296,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_469675296_sm'), '\"', '') AS D_847578001_D_469675296_sm,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_488415137'), '\"', '') AS D_847578001_D_488415137,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_488415137_sm'), '\"', '') AS D_847578001_D_488415137_sm,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_730334054'), '\"', '') AS D_847578001_D_730334054,
	REPLACE(JSON_QUERY(row,'$.D_847578001.D_730334054_sm'), '\"', '') AS D_847578001_D_730334054_sm,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_187399900'), '\"', '') AS D_857165713_D_187399900,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_187399900_sm'), '\"', '') AS D_857165713_D_187399900_sm,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_219358831'), '\"', '') AS D_857165713_D_219358831,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_219358831_sm'), '\"', '') AS D_857165713_D_219358831_sm,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_243443780'), '\"', '') AS D_857165713_D_243443780,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_243443780_sm'), '\"', '') AS D_857165713_D_243443780_sm,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_357462273'), '\"', '') AS D_857165713_D_357462273,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_357462273_sm'), '\"', '') AS D_857165713_D_357462273_sm,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_636367178'), '\"', '') AS D_857165713_D_636367178,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_636367178_sm'), '\"', '') AS D_857165713_D_636367178_sm,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_638380747'), '\"', '') AS D_857165713_D_638380747,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_638380747_sm'), '\"', '') AS D_857165713_D_638380747_sm,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_847529903'), '\"', '') AS D_857165713_D_847529903,
	REPLACE(JSON_QUERY(row,'$.D_857165713.D_847529903_sm'), '\"', '') AS D_857165713_D_847529903_sm,
