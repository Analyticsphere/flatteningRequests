...
CREATE OR REPLACE TABLE
  ...
  WITH
    ...
    flattened_data AS (
    SELECT
      	REPLACE(JSON_QUERY(row,'$.collectionDetails.d_266600170.d_156605577'), '\"', '') AS collectionDetails_d_266600170_d_156605577,
	REPLACE(JSON_QUERY(row,'$.collectionDetails.d_266600170.d_448660695'), '\"', '') AS collectionDetails_d_266600170_d_448660695,
	REPLACE(JSON_QUERY(row,'$.collectionDetails.d_266600170.d_561681068'), '\"', '') AS collectionDetails_d_266600170_d_561681068,
	REPLACE(JSON_QUERY(row,'$.collectionDetails.d_266600170.d_592099155'), '\"', '') AS collectionDetails_d_266600170_d_592099155,
	REPLACE(JSON_QUERY(row,'$.collectionDetails.d_266600170.d_718172863'), '\"', '') AS collectionDetails_d_266600170_d_718172863,
	REPLACE(JSON_QUERY(row,'$.collectionDetails.d_266600170.d_847159717'), '\"', '') AS collectionDetails_d_266600170_d_847159717,
	REPLACE(JSON_QUERY(row,'$.collectionDetails.d_266600170.d_880794013'), '\"', '') AS collectionDetails_d_266600170_d_880794013,
	REPLACE(JSON_QUERY(row,'$.collectionDetails.d_266600170.d_915179629'), '\"', '') AS collectionDetails_d_266600170_d_915179629,
	...
	REPLACE(JSON_QUERY(row,'$.d_777888999.d_3'), '\"', '') AS d_777888999_d_3,
	REPLACE(JSON_QUERY(row,'$.d_777888999.d_4'), '\"', '') AS d_777888999_d_4,
	REPLACE(JSON_QUERY(row,'$.d_777888999.d_5'), '\"', '') AS d_777888999_d_5,
