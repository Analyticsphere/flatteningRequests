...
REPLACE(JSON_QUERY(row,'$.d_130371375.d_266600170.d_266600170'), '\"', '') AS d_130371375_d_266600170_d_266600170,
...
REPLACE(JSON_QUERY(row,'$.d_130371375.d_266600170.d_735399790'), '\"', '') AS d_130371375_d_266600170_d_735399790,
...
REPLACE(JSON_QUERY(row,'$.d_173836415'), '\"', '') AS d_173836415,
...
REPLACE(JSON_QUERY(row,'$.d_173836415.d_266600170.d_611091485'), '\"', '') AS d_173836415_d_266600170_d_611091485,
REPLACE(JSON_QUERY(row,'$.d_173836415.d_266600170.d_646899796'), '\"', '') AS d_173836415_d_266600170_d_646899796,
...
REPLACE(JSON_QUERY(row,'$.d_173836415.d_266600170.d_951355211'), '\"', '') AS d_173836415_d_266600170_d_951355211,
REPLACE(JSON_QUERY(row,'$.d_173836415.d_266600170.d_982213346'), '\"', '') AS d_173836415_d_266600170_d_982213346,
REPLACE(JSON_QUERY(row,'$.d_175506524'), '\"', '') AS d_175506524,
...
REPLACE(JSON_QUERY(row,'$.d_266600170'), '\"', '') AS d_266600170,
...
REPLACE(JSON_QUERY(row,'$.d_297147359'), '\"', '') AS d_297147359,
...
REPLACE(JSON_QUERY(row,'$.d_299274441'), '\"', '') AS d_299274441,
...
REPLACE(JSON_QUERY(row,'$.d_303552867'), '\"', '') AS d_303552867,
...
REPLACE(JSON_QUERY(row,'$.d_366295286'), '\"', '') AS d_366295286,
REPLACE(JSON_QUERY(row,'$.d_367051943'), '\"', '') AS d_367051943,
...
REPLACE(JSON_QUERY(row,'$.d_496823485'), '\"', '') AS d_496823485,
...
REPLACE(JSON_QUERY(row,'$.d_524461170'), '\"', '') AS d_524461170,
...
REPLACE(JSON_QUERY(row,'$.d_603278289'), '\"', '') AS d_603278289,
...
REPLACE(JSON_QUERY(row,'$.d_650465111'), '\"', '') AS d_650465111,
...
REPLACE(JSON_QUERY(row,'$.d_706283025.d_163284008'), '\"', '') AS d_706283025_d_163284008,
REPLACE(JSON_QUERY(row,'$.d_706283025.d_387198193'), '\"', '') AS d_706283025_d_387198193,
REPLACE(JSON_QUERY(row,'$.d_706283025.d_491099823'), '\"', '') AS d_706283025_d_491099823,
REPLACE(JSON_QUERY(row,'$.d_706283025.d_497530905'), '\"', '') AS d_706283025_d_497530905,
REPLACE(JSON_QUERY(row,'$.d_706283025.d_566047367'), '\"', '') AS d_706283025_d_566047367,
REPLACE(JSON_QUERY(row,'$.d_706283025.d_771146804'), '\"', '') AS d_706283025_d_771146804,
REPLACE(JSON_QUERY(row,'$.d_706283025.d_873405723'), '\"', '') AS d_706283025_d_873405723,
...
REPLACE(JSON_QUERY(row,'$.d_719222792'), '\"', '') AS d_719222792,
REPLACE(JSON_QUERY(row,'$.d_719222792.d_719222792'), '\"', '') AS d_719222792_d_719222792,
REPLACE(JSON_QUERY(row,'$.d_719222792.d_993855378'), '\"', '') AS d_719222792_d_993855378,
...
REPLACE(JSON_QUERY(row,'$.state.d_480305327'), '\"', '') AS state_d_480305327,
REPLACE(JSON_QUERY(row,'$.state.d_481139103'), '\"', '') AS state_d_481139103,
REPLACE(JSON_QUERY(row,'$.state.d_497530905'), '\"', '') AS state_d_497530905,
...
REPLACE(JSON_QUERY(row,'$.state.d_566047367'), '\"', '') AS state_d_566047367,
...
REPLACE(JSON_QUERY(row,'$.state.d_873405723'), '\"', '') AS state_d_873405723,
