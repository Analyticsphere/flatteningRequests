...
table    <- "Connect.module1_v2"
schema   <- "module1_v2-schema.xlsx"
sheet    <- NULL
out_json <- "module1_v2-lists-from-schema.json" # destination file
out_csv  <- "module1_v2-variables-from-schema.csv"
...
```{r}
A <- "../module1_v2-lists.json"
B <- "module1_v2-lists-from-schema.json"
C <- "module1_v2-lists-union.json"
...
A_csv <- "../module1_v2-variables.csv"
B_csv <- "module1_v2-variables-from-schema.csv"
C_csv <- "module1_v2-variables-union.csv"
...
```{r}
output_filename  <- "module1_v2-lists-union-mod.json"
...
```{r}
out_file  <- "module1_v2-variables-union-new.csv"
...
echo $NEW_CSV  
echo $NEW_JSON
PAR_DIR_CSV_NAME="module1_v2-variables.csv"
PAR_DIR_JSON_NAME="module1_v2-lists.json"
...
node ../module1_v2-query_generator.js
```
