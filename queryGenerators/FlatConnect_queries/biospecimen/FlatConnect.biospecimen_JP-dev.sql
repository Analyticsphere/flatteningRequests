...
""";
  ...
  CREATE OR REPLACE TABLE FlatConnect.biospecimen_JP 
OPTIONS (description="Source table: Connect.biospecimen; Scheduled Query: FlatConnect.biospecimen_JP; GitHub: https://github.com/Analyticsphere/flatteningRequests/tree/main/queryGenerators/FlatConnect_queries/biospecimen; Team: Analytics; Maintainer: Jake Peters; Super Users: Kelsey, Jing; Notes: This table is a flattened version of Connect.biospecimen.") 
AS (
  WITH
  json_data AS (
    SELECT
    ...
    FROM
      `nih-nci-dceg-connect-dev.Connect.biospecimen` AS input_row where Connect_ID is not null
  ),
  flattened_data AS (
    SELECT
