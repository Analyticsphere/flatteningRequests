...
CREATE OR REPLACE TABLE
  ...
  WITH
	...
	REPLACE(JSON_QUERY(row,'$.d_457270069'), '\"', '') AS d_457270069,
	REPLACE(JSON_QUERY(row,'$.d_525972260'), '\"', '') AS d_525972260,
	REPLACE(JSON_QUERY(row,'$.d_740819233.d_149205077.integer'), '\"', '') AS d_740819233_d_149205077_integer,
	REPLACE(JSON_QUERY(row,'$.d_740819233.d_149205077.provided'), '\"', '') AS d_740819233_d_149205077_provided,
	REPLACE(JSON_QUERY(row,'$.d_740819233.d_149205077.string'), '\"', '') AS d_740819233_d_149205077_string,
