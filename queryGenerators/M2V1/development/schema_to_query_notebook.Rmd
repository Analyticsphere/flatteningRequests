...
schema   <- "M2V1_schema.xlsx"
sheet    <- NULL
out_json <- "M2V1-lists.js" # destination file
out_csv  <- "M2V1-variables.csv"

# Set output files ot environment variables for easy cleanup later
...
A_csv <- "M2-variables.csv"
B_csv <- "M2V1-variables.csv"
C_csv <- "M2V1-variables-union.csv"
...
```{r}
json_file         <- "M2V1-lists-union.json"
variables_file    <- "M2V1-variables-union.csv"
...
```{r}
output_filename  <- "M2V1-lists-union-mod.json"
...
```{r}
out_file <- "M2V1-variables-auto-new.csv"
...
echo $NEW_CSV  
echo $NEW_JSON
PAR_DIR_CSV_NAME="M2V1-variables.csv"
PAR_DIR_JSON_NAME="M2V1-lists.json"
