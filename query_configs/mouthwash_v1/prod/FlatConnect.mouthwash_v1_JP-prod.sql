...
-- 
-- source_table: nih-nci-dceg-connect-prod-6d04.Connect.mouthwash_v1
-- destination table: nih-nci-dceg-connect-prod-6d04.FlatConnect.mouthwash_v1_JP -- notes
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-prod-6d04.FlatConnect.mouthwash_v1_JP` -- destination_table
  ...
  WITH
    ...
    FROM
      `nih-nci-dceg-connect-prod-6d04.Connect.mouthwash_v1` AS input_row -- source_table
	...
	REPLACE(JSON_QUERY(row,'$.d_850585325'), '\"', '') AS d_850585325,
