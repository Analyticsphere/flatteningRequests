...
-- destination table: nih-nci-dceg-connect-prod-6d04.FlatConnect.clinicalBioSurvey_v1_JP -- notes
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-prod-6d04.FlatConnect.clinicalBioSurvey_v1_JP` -- destination_table
