...
-- 
-- source_table: nih-nci-dceg-connect-stg-5519.Connect.bioSurvey_v1
-- destination table: nih-nci-dceg-connect-stg-5519.FlatConnect.bioSurvey_v1_JP -- notes
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-stg-5519.FlatConnect.bioSurvey_v1_JP` -- destination_table
  ...
  WITH
    ...
    FROM
      `nih-nci-dceg-connect-stg-5519.Connect.bioSurvey_v1` AS input_row -- source_table
	...
	REPLACE(JSON_QUERY(row,'$.D_715581797_2_2.D_652923023_1'), '\"', '') AS D_715581797_2_2_D_652923023_1,
	...
	REPLACE(JSON_QUERY(row,'$.D_715581797_2_2.D_701387353_1'), '\"', '') AS D_715581797_2_2_D_701387353_1,
