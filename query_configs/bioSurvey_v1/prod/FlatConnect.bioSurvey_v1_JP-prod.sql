...
-- 
-- source_table: nih-nci-dceg-connect-prod-6d04.Connect.bioSurvey_v1
-- destination table: nih-nci-dceg-connect-prod-6d04.FlatConnect.bioSurvey_v1_JP -- notes
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-prod-6d04.FlatConnect.bioSurvey_v1_JP` -- destination_table
  ...
  WITH
    ...
    FROM
      `nih-nci-dceg-connect-prod-6d04.Connect.bioSurvey_v1` AS input_row -- source_table
	...
	REPLACE(JSON_QUERY(row,'$.D_899251483_V2.D_104430631'), '\"', '') AS D_899251483_V2_D_104430631,
