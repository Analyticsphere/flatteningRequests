...
-- 
-- source_table: nih-nci-dceg-connect-prod-6d04.Connect.experience2024
-- destination table: nih-nci-dceg-connect-prod-6d04.FlatConnect.experience2024_JP -- notes
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-prod-6d04.FlatConnect.experience2024_JP` -- destination_table
  ...
  WITH
    ...
    FROM
      `nih-nci-dceg-connect-prod-6d04.Connect.experience2024` AS input_row -- source_table
	...
	REPLACE(JSON_QUERY(row,'$.D_943119849.D_314351052'), '\"', '') AS D_943119849_D_314351052,
	...
	REPLACE(JSON_QUERY(row,'$.D_960544981.d_490731188'), '\"', '') AS D_960544981_d_490731188,
	...
	REPLACE(JSON_QUERY(row,'$.D_960544981.d_847753225'), '\"', '') AS D_960544981_d_847753225,
