...
CREATE OR REPLACE TABLE
  ...
  WITH
	...
	REPLACE(JSON_QUERY(row,'$.D_424548783.float'), '\"', '') AS D_424548783_float,
	REPLACE(JSON_QUERY(row,'$.D_424548783.integer'), '\"', '') AS D_424548783_integer,
	REPLACE(JSON_QUERY(row,'$.D_424548783.provided'), '\"', '') AS D_424548783_provided,
	...
	REPLACE(JSON_QUERY(row,'$.D_697423629.float'), '\"', '') AS D_697423629_float,
	REPLACE(JSON_QUERY(row,'$.D_697423629.integer'), '\"', '') AS D_697423629_integer,
	REPLACE(JSON_QUERY(row,'$.D_697423629.provided'), '\"', '') AS D_697423629_provided,
