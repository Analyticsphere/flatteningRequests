...
CREATE TEMP FUNCTION
  ...
  const arraysToBeFlattened= {
    ...
    "D_705336878_10_10.D_705336878_10_10": [
        160627865,
        579409935,
        960642359
    ],
    "D_705336878_13_13.D_705336878_13_13": [
        423283665
    ],
...
CREATE OR REPLACE TABLE
  ...
  WITH
	...
	REPLACE(JSON_QUERY(row,'$.D_108733102_10_10'), '\"', '') AS D_108733102_10_10,
	...
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_108389123'), '\"', '') AS D_114280729_entity_D_108389123,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_109223043'), '\"', '') AS D_114280729_entity_D_109223043,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_336856410'), '\"', '') AS D_114280729_entity_D_336856410,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_368669706'), '\"', '') AS D_114280729_entity_D_368669706,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_374567479'), '\"', '') AS D_114280729_entity_D_374567479,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_481587023'), '\"', '') AS D_114280729_entity_D_481587023,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_518602598'), '\"', '') AS D_114280729_entity_D_518602598,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_590361055'), '\"', '') AS D_114280729_entity_D_590361055,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_605818246'), '\"', '') AS D_114280729_entity_D_605818246,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_702905707'), '\"', '') AS D_114280729_entity_D_702905707,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_747085418'), '\"', '') AS D_114280729_entity_D_747085418,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_770190369'), '\"', '') AS D_114280729_entity_D_770190369,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_790860504'), '\"', '') AS D_114280729_entity_D_790860504,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_966214244'), '\"', '') AS D_114280729_entity_D_966214244,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_986119909'), '\"', '') AS D_114280729_entity_D_986119909,
	REPLACE(JSON_QUERY(row,'$.D_114280729.entity.D_994153376'), '\"', '') AS D_114280729_entity_D_994153376,
	REPLACE(JSON_QUERY(row,'$.D_114280729.provided'), '\"', '') AS D_114280729_provided,
	REPLACE(JSON_QUERY(row,'$.D_114280729.string'), '\"', '') AS D_114280729_string,
	...
	REPLACE(JSON_QUERY(row,'$.D_169509213_4_4'), '\"', '') AS D_169509213_4_4,
	REPLACE(JSON_QUERY(row,'$.D_169509213_8_8'), '\"', '') AS D_169509213_8_8,
	...
	REPLACE(JSON_QUERY(row,'$.D_179406442_5_5'), '\"', '') AS D_179406442_5_5,
	REPLACE(JSON_QUERY(row,'$.D_179406442_8_8'), '\"', '') AS D_179406442_8_8,
	...
	REPLACE(JSON_QUERY(row,'$.D_220055064_8_8.D_395747093_8_8'), '\"', '') AS D_220055064_8_8_D_395747093_8_8,
	...
	REPLACE(JSON_QUERY(row,'$.D_389465772_10_10'), '\"', '') AS D_389465772_10_10,
	...
	REPLACE(JSON_QUERY(row,'$.D_430166879_4_4'), '\"', '') AS D_430166879_4_4,
	REPLACE(JSON_QUERY(row,'$.D_430166879_8_8'), '\"', '') AS D_430166879_8_8,
	REPLACE(JSON_QUERY(row,'$.D_451163824_1_1'), '\"', '') AS D_451163824_1_1,
	REPLACE(JSON_QUERY(row,'$.D_451163824_10_10'), '\"', '') AS D_451163824_10_10,
	REPLACE(JSON_QUERY(row,'$.D_451163824_13_13'), '\"', '') AS D_451163824_13_13,
	...
	REPLACE(JSON_QUERY(row,'$.D_451163824_9_9'), '\"', '') AS D_451163824_9_9,
	...
	REPLACE(JSON_QUERY(row,'$.D_705336878_10_10.D_705336878_10_10.D_160627865'), '\"', '') AS D_705336878_10_10_D_705336878_10_10_D_160627865,
	REPLACE(JSON_QUERY(row,'$.D_705336878_10_10.D_705336878_10_10.D_579409935'), '\"', '') AS D_705336878_10_10_D_705336878_10_10_D_579409935,
	REPLACE(JSON_QUERY(row,'$.D_705336878_10_10.D_705336878_10_10.D_960642359'), '\"', '') AS D_705336878_10_10_D_705336878_10_10_D_960642359,
	REPLACE(JSON_QUERY(row,'$.D_705336878_13_13.D_705336878_13_13.D_423283665'), '\"', '') AS D_705336878_13_13_D_705336878_13_13_D_423283665,
	...
	REPLACE(JSON_QUERY(row,'$.D_705336878_5_5.D_705336878_5_5.D_283776061'), '\"', '') AS D_705336878_5_5_D_705336878_5_5_D_283776061,
	...
	REPLACE(JSON_QUERY(row,'$.D_705336878_5_5.D_705336878_5_5.D_657566099'), '\"', '') AS D_705336878_5_5_D_705336878_5_5_D_657566099,
	...
	REPLACE(JSON_QUERY(row,'$.D_705336878_6_6.D_705336878_6_6.D_807835037'), '\"', '') AS D_705336878_6_6_D_705336878_6_6_D_807835037,
	...
	REPLACE(JSON_QUERY(row,'$.D_705336878_8_8.D_705336878_8_8.D_160627865'), '\"', '') AS D_705336878_8_8_D_705336878_8_8_D_160627865,
	REPLACE(JSON_QUERY(row,'$.D_705336878_8_8.D_705336878_8_8.D_423283665'), '\"', '') AS D_705336878_8_8_D_705336878_8_8_D_423283665,
	REPLACE(JSON_QUERY(row,'$.D_705336878_9_9.D_705336878_9_9.D_160627865'), '\"', '') AS D_705336878_9_9_D_705336878_9_9_D_160627865,
	REPLACE(JSON_QUERY(row,'$.D_705336878_9_9.D_705336878_9_9.D_162167690'), '\"', '') AS D_705336878_9_9_D_705336878_9_9_D_162167690,
	REPLACE(JSON_QUERY(row,'$.D_705336878_9_9.D_705336878_9_9.D_367747257'), '\"', '') AS D_705336878_9_9_D_705336878_9_9_D_367747257,
	REPLACE(JSON_QUERY(row,'$.D_705336878_9_9.D_705336878_9_9.D_960642359'), '\"', '') AS D_705336878_9_9_D_705336878_9_9_D_960642359,
	REPLACE(JSON_QUERY(row,'$.D_71558179_V2_1_1'), '\"', '') AS D_71558179_V2_1_1,
	REPLACE(JSON_QUERY(row,'$.D_71558179_V2_10_10'), '\"', '') AS D_71558179_V2_10_10,
	...
	REPLACE(JSON_QUERY(row,'$.D_71558179_V2_9_9'), '\"', '') AS D_71558179_V2_9_9,
	...
	REPLACE(JSON_QUERY(row,'$.D_744230001_5_5'), '\"', '') AS D_744230001_5_5,
	REPLACE(JSON_QUERY(row,'$.D_744230001_8_8'), '\"', '') AS D_744230001_8_8,
	...
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_143206081'), '\"', '') AS D_749956170_entity_D_143206081,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_144819886'), '\"', '') AS D_749956170_entity_D_144819886,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_223008071'), '\"', '') AS D_749956170_entity_D_223008071,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_246857412'), '\"', '') AS D_749956170_entity_D_246857412,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_304155106'), '\"', '') AS D_749956170_entity_D_304155106,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_431203595'), '\"', '') AS D_749956170_entity_D_431203595,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_463689026'), '\"', '') AS D_749956170_entity_D_463689026,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_516899143'), '\"', '') AS D_749956170_entity_D_516899143,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_527872064'), '\"', '') AS D_749956170_entity_D_527872064,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_599862694'), '\"', '') AS D_749956170_entity_D_599862694,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_691752394'), '\"', '') AS D_749956170_entity_D_691752394,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_830581863'), '\"', '') AS D_749956170_entity_D_830581863,
	REPLACE(JSON_QUERY(row,'$.D_749956170.entity.D_860444009'), '\"', '') AS D_749956170_entity_D_860444009,
	REPLACE(JSON_QUERY(row,'$.D_749956170.provided'), '\"', '') AS D_749956170_provided,
	REPLACE(JSON_QUERY(row,'$.D_749956170.string'), '\"', '') AS D_749956170_string,
	...
	REPLACE(JSON_QUERY(row,'$.D_775313030_10_10'), '\"', '') AS D_775313030_10_10,
	...
	REPLACE(JSON_QUERY(row,'$.D_782396371_5_5'), '\"', '') AS D_782396371_5_5,
	REPLACE(JSON_QUERY(row,'$.D_782396371_8_8'), '\"', '') AS D_782396371_8_8,
	...
	REPLACE(JSON_QUERY(row,'$.D_803339020_4_4'), '\"', '') AS D_803339020_4_4,
	REPLACE(JSON_QUERY(row,'$.D_803339020_8_8'), '\"', '') AS D_803339020_8_8,
	...
	REPLACE(JSON_QUERY(row,'$.D_893966847_5_5'), '\"', '') AS D_893966847_5_5,
	REPLACE(JSON_QUERY(row,'$.D_893966847_8_8'), '\"', '') AS D_893966847_8_8,
	REPLACE(JSON_QUERY(row,'$.D_928530823_1_1'), '\"', '') AS D_928530823_1_1,
	REPLACE(JSON_QUERY(row,'$.D_928530823_10_10'), '\"', '') AS D_928530823_10_10,
	REPLACE(JSON_QUERY(row,'$.D_928530823_13_13'), '\"', '') AS D_928530823_13_13,
	...
	REPLACE(JSON_QUERY(row,'$.D_928530823_8_8'), '\"', '') AS D_928530823_8_8,
	...
	REPLACE(JSON_QUERY(row,'$.D_930944000_5_5'), '\"', '') AS D_930944000_5_5,
	REPLACE(JSON_QUERY(row,'$.D_930944000_8_8'), '\"', '') AS D_930944000_8_8,
	...
	REPLACE(JSON_QUERY(row,'$.D_984121390_5_5'), '\"', '') AS D_984121390_5_5,
	REPLACE(JSON_QUERY(row,'$.D_984121390_8_8'), '\"', '') AS D_984121390_8_8,
