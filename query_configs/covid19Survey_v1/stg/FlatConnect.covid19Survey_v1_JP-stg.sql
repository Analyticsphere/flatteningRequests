...
-- 
-- source_table: nih-nci-dceg-connect-stg-5519.Connect.covid19Survey_v1
-- destination table: nih-nci-dceg-connect-stg-5519.FlatConnect.covid19Survey_v1_JP -- notes
...
CREATE TEMP FUNCTION
  ...
  const arraysToBeFlattened= {
    ...
    "D_705336878_15_15.D_705336878_15_15": [
        657566099,
        807835037
    ],
    "D_705336878_16_16.D_705336878_16_16": [
        807835037
    ],
    "D_705336878_18_18.D_705336878_18_18": [
        807835037
    ],
    "D_705336878_19_19.D_705336878_19_19": [
        162167690,
        406943303,
        684149600,
        960642359
    ...
    "D_705336878_20_20.D_705336878_20_20": [
        367747257,
        579409935,
        760243464,
        896163801
    ],
    "D_705336878_21_21.D_705336878_21_21": [
        283776061,
        423283665,
        653630699,
        657566099,
    ...
    "D_705336878_22_22.D_705336878_22_22": [
        160627865,
        178318661,
        679368947,
        810340693
    ],
    "D_705336878_23_23.D_705336878_23_23": [
        406943303,
        524258008,
        579409935,
        756774083,
    ...
    "D_705336878_24_24.D_705336878_24_24": [
        162167690,
        423283665,
        653630699,
        760243464
    ],
    "D_705336878_25_25.D_705336878_25_25": [
        160627865,
        367747257,
        679368947,
        896163801
    ...
    "D_705336878_8_8.D_705336878_8_8": [
        178318661,
        524258008,
        679368947
    ],
    "D_705336878_9_9.D_705336878_9_9": [
        283776061,
        810340693
    ]
}
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-stg-5519.FlatConnect.covid19Survey_v1_JP` -- destination_table
  ...
  WITH
    ...
    FROM
      `nih-nci-dceg-connect-stg-5519.Connect.covid19Survey_v1` AS input_row -- source_table
	...
	REPLACE(JSON_QUERY(row,'$.D_108733102_15_15'), '\"', '') AS D_108733102_15_15,
	REPLACE(JSON_QUERY(row,'$.D_108733102_16_16'), '\"', '') AS D_108733102_16_16,
	REPLACE(JSON_QUERY(row,'$.D_108733102_17_17'), '\"', '') AS D_108733102_17_17,
	REPLACE(JSON_QUERY(row,'$.D_108733102_18_18'), '\"', '') AS D_108733102_18_18,
	REPLACE(JSON_QUERY(row,'$.D_108733102_19_19'), '\"', '') AS D_108733102_19_19,
	REPLACE(JSON_QUERY(row,'$.D_108733102_2_2'), '\"', '') AS D_108733102_2_2,
	REPLACE(JSON_QUERY(row,'$.D_108733102_20_20'), '\"', '') AS D_108733102_20_20,
	REPLACE(JSON_QUERY(row,'$.D_108733102_21_21'), '\"', '') AS D_108733102_21_21,
	REPLACE(JSON_QUERY(row,'$.D_108733102_22_22'), '\"', '') AS D_108733102_22_22,
	REPLACE(JSON_QUERY(row,'$.D_108733102_24_24'), '\"', '') AS D_108733102_24_24,
	...
	REPLACE(JSON_QUERY(row,'$.D_108733102_8_8'), '\"', '') AS D_108733102_8_8,
	REPLACE(JSON_QUERY(row,'$.D_108733102_9_9'), '\"', '') AS D_108733102_9_9,
	...
	REPLACE(JSON_QUERY(row,'$.D_169509213_9_9'), '\"', '') AS D_169509213_9_9,
	REPLACE(JSON_QUERY(row,'$.D_179406442_1_1'), '\"', '') AS D_179406442_1_1,
	REPLACE(JSON_QUERY(row,'$.D_179406442_18_18'), '\"', '') AS D_179406442_18_18,
	REPLACE(JSON_QUERY(row,'$.D_179406442_19_19'), '\"', '') AS D_179406442_19_19,
	REPLACE(JSON_QUERY(row,'$.D_179406442_2_2'), '\"', '') AS D_179406442_2_2,
	REPLACE(JSON_QUERY(row,'$.D_179406442_24_24'), '\"', '') AS D_179406442_24_24,
	REPLACE(JSON_QUERY(row,'$.D_179406442_3_3'), '\"', '') AS D_179406442_3_3,
	REPLACE(JSON_QUERY(row,'$.D_179406442_4_4'), '\"', '') AS D_179406442_4_4,
	REPLACE(JSON_QUERY(row,'$.D_179406442_9_9'), '\"', '') AS D_179406442_9_9,
	...
	REPLACE(JSON_QUERY(row,'$.D_366980310_10_10'), '\"', '') AS D_366980310_10_10,
	REPLACE(JSON_QUERY(row,'$.D_366980310_11_11'), '\"', '') AS D_366980310_11_11,
	REPLACE(JSON_QUERY(row,'$.D_366980310_12_12'), '\"', '') AS D_366980310_12_12,
	REPLACE(JSON_QUERY(row,'$.D_366980310_13_13'), '\"', '') AS D_366980310_13_13,
	REPLACE(JSON_QUERY(row,'$.D_366980310_14_14'), '\"', '') AS D_366980310_14_14,
	REPLACE(JSON_QUERY(row,'$.D_366980310_15_15'), '\"', '') AS D_366980310_15_15,
	REPLACE(JSON_QUERY(row,'$.D_366980310_16_16'), '\"', '') AS D_366980310_16_16,
	REPLACE(JSON_QUERY(row,'$.D_366980310_17_17'), '\"', '') AS D_366980310_17_17,
	REPLACE(JSON_QUERY(row,'$.D_366980310_2_2'), '\"', '') AS D_366980310_2_2,
	REPLACE(JSON_QUERY(row,'$.D_366980310_23_23'), '\"', '') AS D_366980310_23_23,
	REPLACE(JSON_QUERY(row,'$.D_366980310_24_24'), '\"', '') AS D_366980310_24_24,
	REPLACE(JSON_QUERY(row,'$.D_366980310_25_25'), '\"', '') AS D_366980310_25_25,
	...
	REPLACE(JSON_QUERY(row,'$.D_366980310_8_8'), '\"', '') AS D_366980310_8_8,
	REPLACE(JSON_QUERY(row,'$.D_366980310_9_9'), '\"', '') AS D_366980310_9_9,
	REPLACE(JSON_QUERY(row,'$.D_389465772_1_1'), '\"', '') AS D_389465772_1_1,
	REPLACE(JSON_QUERY(row,'$.D_389465772_15_15'), '\"', '') AS D_389465772_15_15,
	REPLACE(JSON_QUERY(row,'$.D_389465772_17_17'), '\"', '') AS D_389465772_17_17,
	REPLACE(JSON_QUERY(row,'$.D_389465772_18_18'), '\"', '') AS D_389465772_18_18,
	REPLACE(JSON_QUERY(row,'$.D_389465772_19_19'), '\"', '') AS D_389465772_19_19,
	REPLACE(JSON_QUERY(row,'$.D_389465772_2_2'), '\"', '') AS D_389465772_2_2,
	REPLACE(JSON_QUERY(row,'$.D_389465772_20_20'), '\"', '') AS D_389465772_20_20,
	REPLACE(JSON_QUERY(row,'$.D_389465772_23_23'), '\"', '') AS D_389465772_23_23,
	REPLACE(JSON_QUERY(row,'$.D_389465772_25_25'), '\"', '') AS D_389465772_25_25,
	...
	REPLACE(JSON_QUERY(row,'$.D_389465772_8_8'), '\"', '') AS D_389465772_8_8,
	REPLACE(JSON_QUERY(row,'$.D_389465772_9_9'), '\"', '') AS D_389465772_9_9,
	REPLACE(JSON_QUERY(row,'$.D_430166879_1_1'), '\"', '') AS D_430166879_1_1,
	REPLACE(JSON_QUERY(row,'$.D_430166879_23_23'), '\"', '') AS D_430166879_23_23,
	REPLACE(JSON_QUERY(row,'$.D_451163824_1_1'), '\"', '') AS D_451163824_1_1,
	REPLACE(JSON_QUERY(row,'$.D_451163824_15_15'), '\"', '') AS D_451163824_15_15,
	REPLACE(JSON_QUERY(row,'$.D_451163824_16_16'), '\"', '') AS D_451163824_16_16,
	REPLACE(JSON_QUERY(row,'$.D_451163824_17_17'), '\"', '') AS D_451163824_17_17,
	REPLACE(JSON_QUERY(row,'$.D_451163824_18_18'), '\"', '') AS D_451163824_18_18,
	REPLACE(JSON_QUERY(row,'$.D_451163824_19_19'), '\"', '') AS D_451163824_19_19,
	REPLACE(JSON_QUERY(row,'$.D_451163824_2_2'), '\"', '') AS D_451163824_2_2,
	REPLACE(JSON_QUERY(row,'$.D_451163824_20_20'), '\"', '') AS D_451163824_20_20,
	REPLACE(JSON_QUERY(row,'$.D_451163824_21_21'), '\"', '') AS D_451163824_21_21,
	REPLACE(JSON_QUERY(row,'$.D_451163824_22_22'), '\"', '') AS D_451163824_22_22,
	REPLACE(JSON_QUERY(row,'$.D_451163824_23_23'), '\"', '') AS D_451163824_23_23,
	...
	REPLACE(JSON_QUERY(row,'$.D_451163824_8_8'), '\"', '') AS D_451163824_8_8,
	REPLACE(JSON_QUERY(row,'$.D_494226443'), '\"', '') AS D_494226443,
	REPLACE(JSON_QUERY(row,'$.D_498462481_1_1'), '\"', '') AS D_498462481_1_1,
	REPLACE(JSON_QUERY(row,'$.D_498462481_11_11'), '\"', '') AS D_498462481_11_11,
	REPLACE(JSON_QUERY(row,'$.D_498462481_12_12'), '\"', '') AS D_498462481_12_12,
	REPLACE(JSON_QUERY(row,'$.D_498462481_14_14'), '\"', '') AS D_498462481_14_14,
	REPLACE(JSON_QUERY(row,'$.D_498462481_15_15'), '\"', '') AS D_498462481_15_15,
	REPLACE(JSON_QUERY(row,'$.D_498462481_17_17'), '\"', '') AS D_498462481_17_17,
	REPLACE(JSON_QUERY(row,'$.D_498462481_18_18'), '\"', '') AS D_498462481_18_18,
	REPLACE(JSON_QUERY(row,'$.D_498462481_19_19'), '\"', '') AS D_498462481_19_19,
	REPLACE(JSON_QUERY(row,'$.D_498462481_2_2'), '\"', '') AS D_498462481_2_2,
	REPLACE(JSON_QUERY(row,'$.D_498462481_21_21'), '\"', '') AS D_498462481_21_21,
	REPLACE(JSON_QUERY(row,'$.D_498462481_22_22'), '\"', '') AS D_498462481_22_22,
	REPLACE(JSON_QUERY(row,'$.D_498462481_24_24'), '\"', '') AS D_498462481_24_24,
	...
	REPLACE(JSON_QUERY(row,'$.D_694503437_10_10'), '\"', '') AS D_694503437_10_10,
	REPLACE(JSON_QUERY(row,'$.D_694503437_11_11'), '\"', '') AS D_694503437_11_11,
	REPLACE(JSON_QUERY(row,'$.D_694503437_12_12'), '\"', '') AS D_694503437_12_12,
	REPLACE(JSON_QUERY(row,'$.D_694503437_13_13'), '\"', '') AS D_694503437_13_13,
	REPLACE(JSON_QUERY(row,'$.D_694503437_14_14'), '\"', '') AS D_694503437_14_14,
	REPLACE(JSON_QUERY(row,'$.D_694503437_2_2'), '\"', '') AS D_694503437_2_2,
	REPLACE(JSON_QUERY(row,'$.D_694503437_20_20'), '\"', '') AS D_694503437_20_20,
	REPLACE(JSON_QUERY(row,'$.D_694503437_23_23'), '\"', '') AS D_694503437_23_23,
	REPLACE(JSON_QUERY(row,'$.D_694503437_24_24'), '\"', '') AS D_694503437_24_24,
	REPLACE(JSON_QUERY(row,'$.D_694503437_25_25'), '\"', '') AS D_694503437_25_25,
	...
	REPLACE(JSON_QUERY(row,'$.D_694503437_8_8'), '\"', '') AS D_694503437_8_8,
	REPLACE(JSON_QUERY(row,'$.D_694503437_9_9'), '\"', '') AS D_694503437_9_9,
	...
	REPLACE(JSON_QUERY(row,'$.D_705336878_15_15.D_218852075_15_15'), '\"', '') AS D_705336878_15_15_D_218852075_15_15,
	REPLACE(JSON_QUERY(row,'$.D_705336878_15_15.D_705336878_15_15.D_657566099'), '\"', '') AS D_705336878_15_15_D_705336878_15_15_D_657566099,
	REPLACE(JSON_QUERY(row,'$.D_705336878_15_15.D_705336878_15_15.D_807835037'), '\"', '') AS D_705336878_15_15_D_705336878_15_15_D_807835037,
	REPLACE(JSON_QUERY(row,'$.D_705336878_16_16.D_218852075_16_16'), '\"', '') AS D_705336878_16_16_D_218852075_16_16,
	REPLACE(JSON_QUERY(row,'$.D_705336878_16_16.D_705336878_16_16.D_807835037'), '\"', '') AS D_705336878_16_16_D_705336878_16_16_D_807835037,
	REPLACE(JSON_QUERY(row,'$.D_705336878_18_18.D_218852075_18_18'), '\"', '') AS D_705336878_18_18_D_218852075_18_18,
	REPLACE(JSON_QUERY(row,'$.D_705336878_18_18.D_705336878_18_18.D_807835037'), '\"', '') AS D_705336878_18_18_D_705336878_18_18_D_807835037,
	REPLACE(JSON_QUERY(row,'$.D_705336878_19_19.D_705336878_19_19.D_162167690'), '\"', '') AS D_705336878_19_19_D_705336878_19_19_D_162167690,
	REPLACE(JSON_QUERY(row,'$.D_705336878_19_19.D_705336878_19_19.D_406943303'), '\"', '') AS D_705336878_19_19_D_705336878_19_19_D_406943303,
	REPLACE(JSON_QUERY(row,'$.D_705336878_19_19.D_705336878_19_19.D_684149600'), '\"', '') AS D_705336878_19_19_D_705336878_19_19_D_684149600,
	REPLACE(JSON_QUERY(row,'$.D_705336878_19_19.D_705336878_19_19.D_960642359'), '\"', '') AS D_705336878_19_19_D_705336878_19_19_D_960642359,
	...
	REPLACE(JSON_QUERY(row,'$.D_705336878_20_20.D_705336878_20_20.D_367747257'), '\"', '') AS D_705336878_20_20_D_705336878_20_20_D_367747257,
	REPLACE(JSON_QUERY(row,'$.D_705336878_20_20.D_705336878_20_20.D_579409935'), '\"', '') AS D_705336878_20_20_D_705336878_20_20_D_579409935,
	REPLACE(JSON_QUERY(row,'$.D_705336878_20_20.D_705336878_20_20.D_760243464'), '\"', '') AS D_705336878_20_20_D_705336878_20_20_D_760243464,
	REPLACE(JSON_QUERY(row,'$.D_705336878_20_20.D_705336878_20_20.D_896163801'), '\"', '') AS D_705336878_20_20_D_705336878_20_20_D_896163801,
	REPLACE(JSON_QUERY(row,'$.D_705336878_21_21.D_705336878_21_21.D_283776061'), '\"', '') AS D_705336878_21_21_D_705336878_21_21_D_283776061,
	REPLACE(JSON_QUERY(row,'$.D_705336878_21_21.D_705336878_21_21.D_423283665'), '\"', '') AS D_705336878_21_21_D_705336878_21_21_D_423283665,
	REPLACE(JSON_QUERY(row,'$.D_705336878_21_21.D_705336878_21_21.D_653630699'), '\"', '') AS D_705336878_21_21_D_705336878_21_21_D_653630699,
	REPLACE(JSON_QUERY(row,'$.D_705336878_21_21.D_705336878_21_21.D_657566099'), '\"', '') AS D_705336878_21_21_D_705336878_21_21_D_657566099,
	REPLACE(JSON_QUERY(row,'$.D_705336878_21_21.D_705336878_21_21.D_756774083'), '\"', '') AS D_705336878_21_21_D_705336878_21_21_D_756774083,
	REPLACE(JSON_QUERY(row,'$.D_705336878_22_22.D_705336878_22_22.D_160627865'), '\"', '') AS D_705336878_22_22_D_705336878_22_22_D_160627865,
	REPLACE(JSON_QUERY(row,'$.D_705336878_22_22.D_705336878_22_22.D_178318661'), '\"', '') AS D_705336878_22_22_D_705336878_22_22_D_178318661,
	REPLACE(JSON_QUERY(row,'$.D_705336878_22_22.D_705336878_22_22.D_679368947'), '\"', '') AS D_705336878_22_22_D_705336878_22_22_D_679368947,
	REPLACE(JSON_QUERY(row,'$.D_705336878_22_22.D_705336878_22_22.D_810340693'), '\"', '') AS D_705336878_22_22_D_705336878_22_22_D_810340693,
	REPLACE(JSON_QUERY(row,'$.D_705336878_23_23.D_705336878_23_23.D_406943303'), '\"', '') AS D_705336878_23_23_D_705336878_23_23_D_406943303,
	REPLACE(JSON_QUERY(row,'$.D_705336878_23_23.D_705336878_23_23.D_524258008'), '\"', '') AS D_705336878_23_23_D_705336878_23_23_D_524258008,
	REPLACE(JSON_QUERY(row,'$.D_705336878_23_23.D_705336878_23_23.D_579409935'), '\"', '') AS D_705336878_23_23_D_705336878_23_23_D_579409935,
	REPLACE(JSON_QUERY(row,'$.D_705336878_23_23.D_705336878_23_23.D_756774083'), '\"', '') AS D_705336878_23_23_D_705336878_23_23_D_756774083,
	REPLACE(JSON_QUERY(row,'$.D_705336878_23_23.D_705336878_23_23.D_810340693'), '\"', '') AS D_705336878_23_23_D_705336878_23_23_D_810340693,
	REPLACE(JSON_QUERY(row,'$.D_705336878_24_24.D_705336878_24_24.D_162167690'), '\"', '') AS D_705336878_24_24_D_705336878_24_24_D_162167690,
	REPLACE(JSON_QUERY(row,'$.D_705336878_24_24.D_705336878_24_24.D_423283665'), '\"', '') AS D_705336878_24_24_D_705336878_24_24_D_423283665,
	REPLACE(JSON_QUERY(row,'$.D_705336878_24_24.D_705336878_24_24.D_653630699'), '\"', '') AS D_705336878_24_24_D_705336878_24_24_D_653630699,
	REPLACE(JSON_QUERY(row,'$.D_705336878_24_24.D_705336878_24_24.D_760243464'), '\"', '') AS D_705336878_24_24_D_705336878_24_24_D_760243464,
	REPLACE(JSON_QUERY(row,'$.D_705336878_25_25.D_705336878_25_25.D_160627865'), '\"', '') AS D_705336878_25_25_D_705336878_25_25_D_160627865,
	REPLACE(JSON_QUERY(row,'$.D_705336878_25_25.D_705336878_25_25.D_367747257'), '\"', '') AS D_705336878_25_25_D_705336878_25_25_D_367747257,
	REPLACE(JSON_QUERY(row,'$.D_705336878_25_25.D_705336878_25_25.D_679368947'), '\"', '') AS D_705336878_25_25_D_705336878_25_25_D_679368947,
	REPLACE(JSON_QUERY(row,'$.D_705336878_25_25.D_705336878_25_25.D_896163801'), '\"', '') AS D_705336878_25_25_D_705336878_25_25_D_896163801,
	...
	REPLACE(JSON_QUERY(row,'$.D_705336878_7_7.D_705336878_7_7.D_684149600'), '\"', '') AS D_705336878_7_7_D_705336878_7_7_D_684149600,
	REPLACE(JSON_QUERY(row,'$.D_705336878_7_7.D_705336878_7_7.D_756774083'), '\"', '') AS D_705336878_7_7_D_705336878_7_7_D_756774083,
	REPLACE(JSON_QUERY(row,'$.D_705336878_7_7.D_705336878_7_7.D_896163801'), '\"', '') AS D_705336878_7_7_D_705336878_7_7_D_896163801,
	REPLACE(JSON_QUERY(row,'$.D_705336878_8_8.D_705336878_8_8.D_178318661'), '\"', '') AS D_705336878_8_8_D_705336878_8_8_D_178318661,
	REPLACE(JSON_QUERY(row,'$.D_705336878_8_8.D_705336878_8_8.D_524258008'), '\"', '') AS D_705336878_8_8_D_705336878_8_8_D_524258008,
	REPLACE(JSON_QUERY(row,'$.D_705336878_8_8.D_705336878_8_8.D_679368947'), '\"', '') AS D_705336878_8_8_D_705336878_8_8_D_679368947,
	REPLACE(JSON_QUERY(row,'$.D_705336878_9_9.D_705336878_9_9.D_283776061'), '\"', '') AS D_705336878_9_9_D_705336878_9_9_D_283776061,
	REPLACE(JSON_QUERY(row,'$.D_705336878_9_9.D_705336878_9_9.D_810340693'), '\"', '') AS D_705336878_9_9_D_705336878_9_9_D_810340693,
	...
	REPLACE(JSON_QUERY(row,'$.D_715581797_V2_10_10'), '\"', '') AS D_715581797_V2_10_10,
	...
	REPLACE(JSON_QUERY(row,'$.D_715581797_V2_7_7'), '\"', '') AS D_715581797_V2_7_7,
	REPLACE(JSON_QUERY(row,'$.D_715581797_V2_8_8'), '\"', '') AS D_715581797_V2_8_8,
	REPLACE(JSON_QUERY(row,'$.D_715581797_V2_9_9'), '\"', '') AS D_715581797_V2_9_9,
	REPLACE(JSON_QUERY(row,'$.D_744230001_1_1'), '\"', '') AS D_744230001_1_1,
	REPLACE(JSON_QUERY(row,'$.D_744230001_19_19'), '\"', '') AS D_744230001_19_19,
	REPLACE(JSON_QUERY(row,'$.D_744230001_2_2'), '\"', '') AS D_744230001_2_2,
	REPLACE(JSON_QUERY(row,'$.D_744230001_23_23'), '\"', '') AS D_744230001_23_23,
	REPLACE(JSON_QUERY(row,'$.D_744230001_24_24'), '\"', '') AS D_744230001_24_24,
	REPLACE(JSON_QUERY(row,'$.D_744230001_3_3'), '\"', '') AS D_744230001_3_3,
	REPLACE(JSON_QUERY(row,'$.D_744230001_4_4'), '\"', '') AS D_744230001_4_4,
	REPLACE(JSON_QUERY(row,'$.D_744230001_9_9'), '\"', '') AS D_744230001_9_9,
	...
	REPLACE(JSON_QUERY(row,'$.D_775313030_15_15'), '\"', '') AS D_775313030_15_15,
	REPLACE(JSON_QUERY(row,'$.D_775313030_16_16'), '\"', '') AS D_775313030_16_16,
	REPLACE(JSON_QUERY(row,'$.D_775313030_18_18'), '\"', '') AS D_775313030_18_18,
	REPLACE(JSON_QUERY(row,'$.D_775313030_19_19'), '\"', '') AS D_775313030_19_19,
	REPLACE(JSON_QUERY(row,'$.D_775313030_2_2'), '\"', '') AS D_775313030_2_2,
	REPLACE(JSON_QUERY(row,'$.D_775313030_20_20'), '\"', '') AS D_775313030_20_20,
	REPLACE(JSON_QUERY(row,'$.D_775313030_21_21'), '\"', '') AS D_775313030_21_21,
	REPLACE(JSON_QUERY(row,'$.D_775313030_23_23'), '\"', '') AS D_775313030_23_23,
	REPLACE(JSON_QUERY(row,'$.D_775313030_24_24'), '\"', '') AS D_775313030_24_24,
	REPLACE(JSON_QUERY(row,'$.D_775313030_25_25'), '\"', '') AS D_775313030_25_25,
	...
	REPLACE(JSON_QUERY(row,'$.D_775313030_8_8'), '\"', '') AS D_775313030_8_8,
	REPLACE(JSON_QUERY(row,'$.D_775313030_9_9'), '\"', '') AS D_775313030_9_9,
	REPLACE(JSON_QUERY(row,'$.D_782396371_1_1'), '\"', '') AS D_782396371_1_1,
	REPLACE(JSON_QUERY(row,'$.D_782396371_19_19'), '\"', '') AS D_782396371_19_19,
	REPLACE(JSON_QUERY(row,'$.D_782396371_2_2'), '\"', '') AS D_782396371_2_2,
	REPLACE(JSON_QUERY(row,'$.D_782396371_23_23'), '\"', '') AS D_782396371_23_23,
	REPLACE(JSON_QUERY(row,'$.D_782396371_24_24'), '\"', '') AS D_782396371_24_24,
	REPLACE(JSON_QUERY(row,'$.D_782396371_3_3'), '\"', '') AS D_782396371_3_3,
	REPLACE(JSON_QUERY(row,'$.D_782396371_9_9'), '\"', '') AS D_782396371_9_9,
	...
	REPLACE(JSON_QUERY(row,'$.D_803339020_24_24'), '\"', '') AS D_803339020_24_24,
	...
	REPLACE(JSON_QUERY(row,'$.D_893966847_19_19'), '\"', '') AS D_893966847_19_19,
	REPLACE(JSON_QUERY(row,'$.D_893966847_2_2'), '\"', '') AS D_893966847_2_2,
	REPLACE(JSON_QUERY(row,'$.D_893966847_23_23'), '\"', '') AS D_893966847_23_23,
	REPLACE(JSON_QUERY(row,'$.D_893966847_24_24'), '\"', '') AS D_893966847_24_24,
	REPLACE(JSON_QUERY(row,'$.D_893966847_3_3'), '\"', '') AS D_893966847_3_3,
	REPLACE(JSON_QUERY(row,'$.D_893966847_4_4'), '\"', '') AS D_893966847_4_4,
	REPLACE(JSON_QUERY(row,'$.D_893966847_9_9'), '\"', '') AS D_893966847_9_9,
	REPLACE(JSON_QUERY(row,'$.D_928530823_1_1'), '\"', '') AS D_928530823_1_1,
	REPLACE(JSON_QUERY(row,'$.D_928530823_16_16'), '\"', '') AS D_928530823_16_16,
	REPLACE(JSON_QUERY(row,'$.D_928530823_17_17'), '\"', '') AS D_928530823_17_17,
	REPLACE(JSON_QUERY(row,'$.D_928530823_18_18'), '\"', '') AS D_928530823_18_18,
	REPLACE(JSON_QUERY(row,'$.D_928530823_19_19'), '\"', '') AS D_928530823_19_19,
	REPLACE(JSON_QUERY(row,'$.D_928530823_2_2'), '\"', '') AS D_928530823_2_2,
	REPLACE(JSON_QUERY(row,'$.D_928530823_21_21'), '\"', '') AS D_928530823_21_21,
	REPLACE(JSON_QUERY(row,'$.D_928530823_22_22'), '\"', '') AS D_928530823_22_22,
	REPLACE(JSON_QUERY(row,'$.D_928530823_23_23'), '\"', '') AS D_928530823_23_23,
	REPLACE(JSON_QUERY(row,'$.D_928530823_24_24'), '\"', '') AS D_928530823_24_24,
	REPLACE(JSON_QUERY(row,'$.D_928530823_25_25'), '\"', '') AS D_928530823_25_25,
	...
	REPLACE(JSON_QUERY(row,'$.D_928530823_9_9'), '\"', '') AS D_928530823_9_9,
	REPLACE(JSON_QUERY(row,'$.D_930944000_1_1'), '\"', '') AS D_930944000_1_1,
	REPLACE(JSON_QUERY(row,'$.D_930944000_19_19'), '\"', '') AS D_930944000_19_19,
	REPLACE(JSON_QUERY(row,'$.D_930944000_2_2'), '\"', '') AS D_930944000_2_2,
	REPLACE(JSON_QUERY(row,'$.D_930944000_3_3'), '\"', '') AS D_930944000_3_3,
	REPLACE(JSON_QUERY(row,'$.D_930944000_9_9'), '\"', '') AS D_930944000_9_9,
	...
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_10_10'), '\"', '') AS D_980800222_V2_10_10,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_11_11'), '\"', '') AS D_980800222_V2_11_11,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_12_12'), '\"', '') AS D_980800222_V2_12_12,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_13_13'), '\"', '') AS D_980800222_V2_13_13,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_14_14'), '\"', '') AS D_980800222_V2_14_14,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_15_15'), '\"', '') AS D_980800222_V2_15_15,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_16_16'), '\"', '') AS D_980800222_V2_16_16,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_17_17'), '\"', '') AS D_980800222_V2_17_17,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_18_18'), '\"', '') AS D_980800222_V2_18_18,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_19_19'), '\"', '') AS D_980800222_V2_19_19,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_2_2'), '\"', '') AS D_980800222_V2_2_2,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_20_20'), '\"', '') AS D_980800222_V2_20_20,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_21_21'), '\"', '') AS D_980800222_V2_21_21,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_22_22'), '\"', '') AS D_980800222_V2_22_22,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_23_23'), '\"', '') AS D_980800222_V2_23_23,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_24_24'), '\"', '') AS D_980800222_V2_24_24,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_25_25'), '\"', '') AS D_980800222_V2_25_25,
	...
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_8_8'), '\"', '') AS D_980800222_V2_8_8,
	REPLACE(JSON_QUERY(row,'$.D_980800222_V2_9_9'), '\"', '') AS D_980800222_V2_9_9,
	REPLACE(JSON_QUERY(row,'$.D_984121390_1_1'), '\"', '') AS D_984121390_1_1,
	REPLACE(JSON_QUERY(row,'$.D_984121390_18_18'), '\"', '') AS D_984121390_18_18,
	REPLACE(JSON_QUERY(row,'$.D_984121390_19_19'), '\"', '') AS D_984121390_19_19,
	REPLACE(JSON_QUERY(row,'$.D_984121390_2_2'), '\"', '') AS D_984121390_2_2,
	REPLACE(JSON_QUERY(row,'$.D_984121390_23_23'), '\"', '') AS D_984121390_23_23,
	REPLACE(JSON_QUERY(row,'$.D_984121390_24_24'), '\"', '') AS D_984121390_24_24,
