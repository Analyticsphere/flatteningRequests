...
-- 
-- source_table: nih-nci-dceg-connect-dev.Connect.notifications
-- destination table: nih-nci-dceg-connect-dev.FlatConnect.notifications_JP -- notes
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-dev.FlatConnect.notifications_JP` -- destination_table
