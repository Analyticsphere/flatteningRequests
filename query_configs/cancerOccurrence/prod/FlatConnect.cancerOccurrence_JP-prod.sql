...
-- 
-- source_table: nih-nci-dceg-connect-prod-6d04.Connect.cancerOccurrence
-- destination table: nih-nci-dceg-connect-prod-6d04.FlatConnect.cancerOccurrence_JP -- notes
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-prod-6d04.FlatConnect.cancerOccurrence_JP` -- destination_table
