...
CREATE OR REPLACE TABLE
  ...
  WITH
	...
	REPLACE(JSON_QUERY(row,'$.d_173836415.d_266600170.d_319972665.d_221592017'), '\"', '') AS d_173836415_d_266600170_d_319972665_d_221592017,
	REPLACE(JSON_QUERY(row,'$.d_173836415.d_266600170.d_319972665.d_379252329'), '\"', '') AS d_173836415_d_266600170_d_319972665_d_379252329,
	REPLACE(JSON_QUERY(row,'$.d_173836415.d_266600170.d_319972665.d_661940160'), '\"', '') AS d_173836415_d_266600170_d_319972665_d_661940160,
	REPLACE(JSON_QUERY(row,'$.d_173836415.d_266600170.d_319972665.d_687158491'), '\"', '') AS d_173836415_d_266600170_d_319972665_d_687158491,
	REPLACE(JSON_QUERY(row,'$.d_173836415.d_266600170.d_319972665.d_826941471'), '\"', '') AS d_173836415_d_266600170_d_319972665_d_826941471,
	...
	REPLACE(JSON_QUERY(row,'$.d_176068627'), '\"', '') AS d_176068627,
	REPLACE(JSON_QUERY(row,'$.d_182718292'), '\"', '') AS d_182718292,
	REPLACE(JSON_QUERY(row,'$.d_187799450'), '\"', '') AS d_187799450,
	REPLACE(JSON_QUERY(row,'$.d_187894482'), '\"', '') AS d_187894482,
	REPLACE(JSON_QUERY(row,'$.d_192505768'), '\"', '') AS d_192505768,
	REPLACE(JSON_QUERY(row,'$.d_195145666'), '\"', '') AS d_195145666,
	REPLACE(JSON_QUERY(row,'$.d_197316935'), '\"', '') AS d_197316935,
	REPLACE(JSON_QUERY(row,'$.d_199471989'), '\"', '') AS d_199471989,
	REPLACE(JSON_QUERY(row,'$.d_205553981'), '\"', '') AS d_205553981,
	REPLACE(JSON_QUERY(row,'$.d_207908218'), '\"', '') AS d_207908218,
	...
	REPLACE(JSON_QUERY(row,'$.d_224392018'), '\"', '') AS d_224392018,
	REPLACE(JSON_QUERY(row,'$.d_230663853'), '\"', '') AS d_230663853,
	REPLACE(JSON_QUERY(row,'$.d_231676651'), '\"', '') AS d_231676651,
	REPLACE(JSON_QUERY(row,'$.d_250235523'), '\"', '') AS d_250235523,
	REPLACE(JSON_QUERY(row,'$.d_250235523.integer'), '\"', '') AS d_250235523_integer,
	REPLACE(JSON_QUERY(row,'$.d_250235523.provided'), '\"', '') AS d_250235523_provided,
	REPLACE(JSON_QUERY(row,'$.d_250235523.string'), '\"', '') AS d_250235523_string,
	REPLACE(JSON_QUERY(row,'$.d_253532712'), '\"', '') AS d_253532712,
	REPLACE(JSON_QUERY(row,'$.d_253883960'), '\"', '') AS d_253883960,
	REPLACE(JSON_QUERY(row,'$.d_254109640'), '\"', '') AS d_254109640,
	REPLACE(JSON_QUERY(row,'$.d_255077064'), '\"', '') AS d_255077064,
	REPLACE(JSON_QUERY(row,'$.d_262357957'), '\"', '') AS d_262357957,
	REPLACE(JSON_QUERY(row,'$.d_262613359'), '\"', '') AS d_262613359,
	REPLACE(JSON_QUERY(row,'$.d_263355177'), '\"', '') AS d_263355177,
	...
	REPLACE(JSON_QUERY(row,'$.d_320303124'), '\"', '') AS d_320303124,
	...
	REPLACE(JSON_QUERY(row,'$.d_337485417'), '\"', '') AS d_337485417,
	...
	REPLACE(JSON_QUERY(row,'$.D_369168474.d_350996955'), '\"', '') AS D_369168474_d_350996955,
	REPLACE(JSON_QUERY(row,'$.D_369168474.d_784119588'), '\"', '') AS D_369168474_d_784119588,
	...
	REPLACE(JSON_QUERY(row,'$.d_384576626'), '\"', '') AS d_384576626,
	...
	REPLACE(JSON_QUERY(row,'$.d_389890053'), '\"', '') AS d_389890053,
	...
	REPLACE(JSON_QUERY(row,'$.d_449168732'), '\"', '') AS d_449168732,
	REPLACE(JSON_QUERY(row,'$.d_451953807'), '\"', '') AS d_451953807,
	REPLACE(JSON_QUERY(row,'$.d_451993790'), '\"', '') AS d_451993790,
	...
	REPLACE(JSON_QUERY(row,'$.d_609630315'), '\"', '') AS d_609630315,
	...
	REPLACE(JSON_QUERY(row,'$.d_667960135'), '\"', '') AS d_667960135,
	...
	REPLACE(JSON_QUERY(row,'$.d_685002411.d_101763809'), '\"', '') AS d_685002411_d_101763809,
	...
	REPLACE(JSON_QUERY(row,'$.d_685002411.d_525277409'), '\"', '') AS d_685002411_d_525277409,
	REPLACE(JSON_QUERY(row,'$.d_685002411.d_671903816'), '\"', '') AS d_685002411_d_671903816,
	REPLACE(JSON_QUERY(row,'$.d_685002411.d_688142378'), '\"', '') AS d_685002411_d_688142378,
	REPLACE(JSON_QUERY(row,'$.d_685002411.d_867203506'), '\"', '') AS d_685002411_d_867203506,
	REPLACE(JSON_QUERY(row,'$.d_685002411.d_936015433'), '\"', '') AS d_685002411_d_936015433,
	REPLACE(JSON_QUERY(row,'$.d_685002411.d_941963821'), '\"', '') AS d_685002411_d_941963821,
	...
	REPLACE(JSON_QUERY(row,'$.d_688172931'), '\"', '') AS d_688172931,
	...
	REPLACE(JSON_QUERY(row,'$.d_777777777'), '\"', '') AS d_777777777,
	...
	REPLACE(JSON_QUERY(row,'$.d_843688458'), '\"', '') AS d_843688458,
	...
	REPLACE(JSON_QUERY(row,'$.d_870643066'), '\"', '') AS d_870643066,
	REPLACE(JSON_QUERY(row,'$.d_875010152'), '\"', '') AS d_875010152,
	REPLACE(JSON_QUERY(row,'$.d_876546260'), '\"', '') AS d_876546260,
	...
	REPLACE(JSON_QUERY(row,'$.d_953225775'), '\"', '') AS d_953225775,
	REPLACE(JSON_QUERY(row,'$.d_956490759'), '\"', '') AS d_956490759,
	REPLACE(JSON_QUERY(row,'$.d_957406695'), '\"', '') AS d_957406695,
	...
	REPLACE(JSON_QUERY(row,'$.state.d_253532712'), '\"', '') AS state_d_253532712,
	REPLACE(JSON_QUERY(row,'$.state.d_35027713'), '\"', '') AS state_d_35027713,
