...
CREATE OR REPLACE TABLE
  ...
  WITH
	...
	REPLACE(JSON_QUERY(row,'$.d_295732360'), '\"', '') AS d_295732360,
	...
	REPLACE(JSON_QUERY(row,'$.d_446235715'), '\"', '') AS d_446235715,
	...
	REPLACE(JSON_QUERY(row,'$.d_749055145'), '\"', '') AS d_749055145,
	...
	REPLACE(JSON_QUERY(row,'$.d_810747471.integer'), '\"', '') AS d_810747471_integer,
	REPLACE(JSON_QUERY(row,'$.d_810747471.provided'), '\"', '') AS d_810747471_provided,
	REPLACE(JSON_QUERY(row,'$.d_810747471.string'), '\"', '') AS d_810747471_string,
	...
	REPLACE(JSON_QUERY(row,'$.utm_campaign'), '\"', '') AS utm_campaign,
	REPLACE(JSON_QUERY(row,'$.utm_medium'), '\"', '') AS utm_medium -- selects
    FROM
      json_data,
      UNNEST(body) AS ROW )
  SELECT
