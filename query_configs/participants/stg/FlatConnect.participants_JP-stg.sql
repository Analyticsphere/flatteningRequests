...
CREATE OR REPLACE TABLE
  ...
  WITH
	...
	REPLACE(JSON_QUERY(row,'$.d_163847117'), '\"', '') AS d_163847117,
	...
	REPLACE(JSON_QUERY(row,'$.d_207613315'), '\"', '') AS d_207613315,
	...
	REPLACE(JSON_QUERY(row,'$.d_284580415'), '\"', '') AS d_284580415,
	REPLACE(JSON_QUERY(row,'$.d_285488731'), '\"', '') AS d_285488731,
	REPLACE(JSON_QUERY(row,'$.d_286149234'), '\"', '') AS d_286149234,
	...
	REPLACE(JSON_QUERY(row,'$.d_318130543'), '\"', '') AS d_318130543,
	...
	REPLACE(JSON_QUERY(row,'$.d_379899229'), '\"', '') AS d_379899229,
	...
	REPLACE(JSON_QUERY(row,'$.d_661719912'), '\"', '') AS d_661719912,
	...
	REPLACE(JSON_QUERY(row,'$.d_686238347.d_295732360'), '\"', '') AS d_686238347_d_295732360,
	REPLACE(JSON_QUERY(row,'$.d_686238347.d_446235715'), '\"', '') AS d_686238347_d_446235715,
	REPLACE(JSON_QUERY(row,'$.d_686238347.d_749055145'), '\"', '') AS d_686238347_d_749055145,
	...
	REPLACE(JSON_QUERY(row,'$.d_728926441'), '\"', '') AS d_728926441,
	...
	REPLACE(JSON_QUERY(row,'$.d_750097000'), '\"', '') AS d_750097000,
	REPLACE(JSON_QUERY(row,'$.d_756862764'), '\"', '') AS d_756862764,
	REPLACE(JSON_QUERY(row,'$.d_761057722'), '\"', '') AS d_761057722,
	...
	REPLACE(JSON_QUERY(row,'$.d_794047378'), '\"', '') AS d_794047378,
	REPLACE(JSON_QUERY(row,'$.d_795827569'), '\"', '') AS d_795827569,
	REPLACE(JSON_QUERY(row,'$.d_801653230'), '\"', '') AS d_801653230,
	REPLACE(JSON_QUERY(row,'$.d_808663245'), '\"', '') AS d_808663245,
	REPLACE(JSON_QUERY(row,'$.d_810747471'), '\"', '') AS d_810747471,
	...
	REPLACE(JSON_QUERY(row,'$.d_907038282'), '\"', '') AS d_907038282,
	...
	REPLACE(JSON_QUERY(row,'$.d_970839481'), '\"', '') AS d_970839481,
