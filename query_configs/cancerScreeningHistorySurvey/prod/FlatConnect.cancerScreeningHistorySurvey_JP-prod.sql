...
-- 
-- source_table: nih-nci-dceg-connect-prod-6d04.Connect.cancerScreeningHistorySurvey
-- destination table: nih-nci-dceg-connect-prod-6d04.FlatConnect.cancerScreeningHistorySurvey_JP -- notes
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-prod-6d04.FlatConnect.cancerScreeningHistorySurvey_JP` -- destination_table
  ...
  WITH
    ...
    FROM
      `nih-nci-dceg-connect-prod-6d04.Connect.cancerScreeningHistorySurvey` AS input_row -- source_table
	...
	REPLACE(JSON_QUERY(row,'$.D_729984625.D_535003378'), '\"', '') AS D_729984625_D_535003378,
