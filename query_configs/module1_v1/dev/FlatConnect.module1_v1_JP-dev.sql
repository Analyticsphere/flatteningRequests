...
-- 
-- source_table: nih-nci-dceg-connect-dev.Connect.module1_v1
-- destination table: nih-nci-dceg-connect-dev.FlatConnect.module1_v1_JP -- notes
...
CREATE OR REPLACE TABLE
  `nih-nci-dceg-connect-dev.FlatConnect.module1_v1_JP` -- destination_table
  ...
  WITH
    ...
    FROM
      `nih-nci-dceg-connect-dev.Connect.module1_v1` AS input_row -- source_table
