...
CREATE OR REPLACE TABLE
  ...
  WITH
	...
	REPLACE(JSON_QUERY(row,'$.D_633553324.entity.D_164707243'), '\"', '') AS D_633553324_entity_D_164707243,
	REPLACE(JSON_QUERY(row,'$.D_633553324.entity.D_175385712'), '\"', '') AS D_633553324_entity_D_175385712,
	REPLACE(JSON_QUERY(row,'$.D_633553324.entity.D_294629316'), '\"', '') AS D_633553324_entity_D_294629316,
	REPLACE(JSON_QUERY(row,'$.D_633553324.entity.D_602102163'), '\"', '') AS D_633553324_entity_D_602102163,
	REPLACE(JSON_QUERY(row,'$.D_633553324.entity.D_771426895'), '\"', '') AS D_633553324_entity_D_771426895,
	REPLACE(JSON_QUERY(row,'$.D_633553324.entity.D_772143730'), '\"', '') AS D_633553324_entity_D_772143730,
	REPLACE(JSON_QUERY(row,'$.D_633553324.entity.D_818310825'), '\"', '') AS D_633553324_entity_D_818310825,
	REPLACE(JSON_QUERY(row,'$.D_633553324.entity.D_843593800'), '\"', '') AS D_633553324_entity_D_843593800,
	REPLACE(JSON_QUERY(row,'$.D_633553324.provided'), '\"', '') AS D_633553324_provided,
	REPLACE(JSON_QUERY(row,'$.D_633553324.string'), '\"', '') AS D_633553324_string,
