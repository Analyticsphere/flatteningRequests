...
tables   <- list(
  ...
  cshs = "cancerScreeningHistorySurvey")

########### DEFINE PARAMETERS ##################################################
tier    <- 'dev' # GCP tiers to update sch. queries for
table   <- tables$cshs # table to be flattened (can only select one)
